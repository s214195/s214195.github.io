(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();function As(t,e){const n=Object.create(null),r=t.split(",");for(let s=0;s<r.length;s++)n[r[s]]=!0;return e?s=>!!n[s.toLowerCase()]:s=>!!n[s]}const Q={},Ht=[],Ae=()=>{},$c=()=>!1,Hc=/^on[^a-z]/,Er=t=>Hc.test(t),Ps=t=>t.startsWith("onUpdate:"),oe=Object.assign,Os=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},jc=Object.prototype.hasOwnProperty,W=(t,e)=>jc.call(t,e),F=Array.isArray,jt=t=>Ir(t)==="[object Map]",xo=t=>Ir(t)==="[object Set]",$=t=>typeof t=="function",se=t=>typeof t=="string",ks=t=>typeof t=="symbol",Z=t=>t!==null&&typeof t=="object",Lo=t=>Z(t)&&$(t.then)&&$(t.catch),Uo=Object.prototype.toString,Ir=t=>Uo.call(t),Wc=t=>Ir(t).slice(8,-1),Fo=t=>Ir(t)==="[object Object]",Ns=t=>se(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Yn=As(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),wr=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},Vc=/-(\w)/g,je=wr(t=>t.replace(Vc,(e,n)=>n?n.toUpperCase():"")),zc=/\B([A-Z])/g,tn=wr(t=>t.replace(zc,"-$1").toLowerCase()),Tr=wr(t=>t.charAt(0).toUpperCase()+t.slice(1)),Fr=wr(t=>t?`on${Tr(t)}`:""),En=(t,e)=>!Object.is(t,e),Xn=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},or=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},ns=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let fi;const rs=()=>fi||(fi=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Ds(t){if(F(t)){const e={};for(let n=0;n<t.length;n++){const r=t[n],s=se(r)?Jc(r):Ds(r);if(s)for(const i in s)e[i]=s[i]}return e}else{if(se(t))return t;if(Z(t))return t}}const Kc=/;(?![^(]*\))/g,qc=/:([^]+)/,Gc=/\/\*[^]*?\*\//g;function Jc(t){const e={};return t.replace(Gc,"").split(Kc).forEach(n=>{if(n){const r=n.split(qc);r.length>1&&(e[r[0].trim()]=r[1].trim())}}),e}function Ms(t){let e="";if(se(t))e=t;else if(F(t))for(let n=0;n<t.length;n++){const r=Ms(t[n]);r&&(e+=r+" ")}else if(Z(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const Yc="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Xc=As(Yc);function Bo(t){return!!t||t===""}const hm=t=>se(t)?t:t==null?"":F(t)||Z(t)&&(t.toString===Uo||!$(t.toString))?JSON.stringify(t,$o,2):String(t),$o=(t,e)=>e&&e.__v_isRef?$o(t,e.value):jt(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[r,s])=>(n[`${r} =>`]=s,n),{})}:xo(e)?{[`Set(${e.size})`]:[...e.values()]}:Z(e)&&!F(e)&&!Fo(e)?String(e):e;let Re;class Qc{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this.parent=Re,!e&&Re&&(this.index=(Re.scopes||(Re.scopes=[])).push(this)-1)}get active(){return this._active}run(e){if(this._active){const n=Re;try{return Re=this,e()}finally{Re=n}}}on(){Re=this}off(){Re=this.parent}stop(e){if(this._active){let n,r;for(n=0,r=this.effects.length;n<r;n++)this.effects[n].stop();for(n=0,r=this.cleanups.length;n<r;n++)this.cleanups[n]();if(this.scopes)for(n=0,r=this.scopes.length;n<r;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!e){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0,this._active=!1}}}function Zc(t,e=Re){e&&e.active&&e.effects.push(t)}function el(){return Re}const xs=t=>{const e=new Set(t);return e.w=0,e.n=0,e},Ho=t=>(t.w&pt)>0,jo=t=>(t.n&pt)>0,tl=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=pt},nl=t=>{const{deps:e}=t;if(e.length){let n=0;for(let r=0;r<e.length;r++){const s=e[r];Ho(s)&&!jo(s)?s.delete(t):e[n++]=s,s.w&=~pt,s.n&=~pt}e.length=n}},ss=new WeakMap;let dn=0,pt=1;const is=30;let Ce;const Tt=Symbol(""),os=Symbol("");class Ls{constructor(e,n=null,r){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,Zc(this,r)}run(){if(!this.active)return this.fn();let e=Ce,n=ut;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=Ce,Ce=this,ut=!0,pt=1<<++dn,dn<=is?tl(this):di(this),this.fn()}finally{dn<=is&&nl(this),pt=1<<--dn,Ce=this.parent,ut=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){Ce===this?this.deferStop=!0:this.active&&(di(this),this.onStop&&this.onStop(),this.active=!1)}}function di(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let ut=!0;const Wo=[];function nn(){Wo.push(ut),ut=!1}function rn(){const t=Wo.pop();ut=t===void 0?!0:t}function me(t,e,n){if(ut&&Ce){let r=ss.get(t);r||ss.set(t,r=new Map);let s=r.get(n);s||r.set(n,s=xs()),Vo(s)}}function Vo(t,e){let n=!1;dn<=is?jo(t)||(t.n|=pt,n=!Ho(t)):n=!t.has(Ce),n&&(t.add(Ce),Ce.deps.push(t))}function Ge(t,e,n,r,s,i){const o=ss.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&F(t)){const c=Number(r);o.forEach((l,u)=>{(u==="length"||u>=c)&&a.push(l)})}else switch(n!==void 0&&a.push(o.get(n)),e){case"add":F(t)?Ns(n)&&a.push(o.get("length")):(a.push(o.get(Tt)),jt(t)&&a.push(o.get(os)));break;case"delete":F(t)||(a.push(o.get(Tt)),jt(t)&&a.push(o.get(os)));break;case"set":jt(t)&&a.push(o.get(Tt));break}if(a.length===1)a[0]&&as(a[0]);else{const c=[];for(const l of a)l&&c.push(...l);as(xs(c))}}function as(t,e){const n=F(t)?t:[...t];for(const r of n)r.computed&&hi(r);for(const r of n)r.computed||hi(r)}function hi(t,e){(t!==Ce||t.allowRecurse)&&(t.scheduler?t.scheduler():t.run())}const rl=As("__proto__,__v_isRef,__isVue"),zo=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(ks)),sl=Us(),il=Us(!1,!0),ol=Us(!0),pi=al();function al(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const r=V(this);for(let i=0,o=this.length;i<o;i++)me(r,"get",i+"");const s=r[e](...n);return s===-1||s===!1?r[e](...n.map(V)):s}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){nn();const r=V(this)[e].apply(this,n);return rn(),r}}),t}function cl(t){const e=V(this);return me(e,"has",t),e.hasOwnProperty(t)}function Us(t=!1,e=!1){return function(r,s,i){if(s==="__v_isReactive")return!t;if(s==="__v_isReadonly")return t;if(s==="__v_isShallow")return e;if(s==="__v_raw"&&i===(t?e?Tl:Yo:e?Jo:Go).get(r))return r;const o=F(r);if(!t){if(o&&W(pi,s))return Reflect.get(pi,s,i);if(s==="hasOwnProperty")return cl}const a=Reflect.get(r,s,i);return(ks(s)?zo.has(s):rl(s))||(t||me(r,"get",s),e)?a:ue(a)?o&&Ns(s)?a:a.value:Z(a)?t?Xo(a):Mn(a):a}}const ll=Ko(),ul=Ko(!0);function Ko(t=!1){return function(n,r,s,i){let o=n[r];if(Jt(o)&&ue(o)&&!ue(s))return!1;if(!t&&(!ar(s)&&!Jt(s)&&(o=V(o),s=V(s)),!F(n)&&ue(o)&&!ue(s)))return o.value=s,!0;const a=F(n)&&Ns(r)?Number(r)<n.length:W(n,r),c=Reflect.set(n,r,s,i);return n===V(i)&&(a?En(s,o)&&Ge(n,"set",r,s):Ge(n,"add",r,s)),c}}function fl(t,e){const n=W(t,e);t[e];const r=Reflect.deleteProperty(t,e);return r&&n&&Ge(t,"delete",e,void 0),r}function dl(t,e){const n=Reflect.has(t,e);return(!ks(e)||!zo.has(e))&&me(t,"has",e),n}function hl(t){return me(t,"iterate",F(t)?"length":Tt),Reflect.ownKeys(t)}const qo={get:sl,set:ll,deleteProperty:fl,has:dl,ownKeys:hl},pl={get:ol,set(t,e){return!0},deleteProperty(t,e){return!0}},gl=oe({},qo,{get:il,set:ul}),Fs=t=>t,Rr=t=>Reflect.getPrototypeOf(t);function Wn(t,e,n=!1,r=!1){t=t.__v_raw;const s=V(t),i=V(e);n||(e!==i&&me(s,"get",e),me(s,"get",i));const{has:o}=Rr(s),a=r?Fs:n?Hs:In;if(o.call(s,e))return a(t.get(e));if(o.call(s,i))return a(t.get(i));t!==s&&t.get(e)}function Vn(t,e=!1){const n=this.__v_raw,r=V(n),s=V(t);return e||(t!==s&&me(r,"has",t),me(r,"has",s)),t===s?n.has(t):n.has(t)||n.has(s)}function zn(t,e=!1){return t=t.__v_raw,!e&&me(V(t),"iterate",Tt),Reflect.get(t,"size",t)}function gi(t){t=V(t);const e=V(this);return Rr(e).has.call(e,t)||(e.add(t),Ge(e,"add",t,t)),this}function mi(t,e){e=V(e);const n=V(this),{has:r,get:s}=Rr(n);let i=r.call(n,t);i||(t=V(t),i=r.call(n,t));const o=s.call(n,t);return n.set(t,e),i?En(e,o)&&Ge(n,"set",t,e):Ge(n,"add",t,e),this}function _i(t){const e=V(this),{has:n,get:r}=Rr(e);let s=n.call(e,t);s||(t=V(t),s=n.call(e,t)),r&&r.call(e,t);const i=e.delete(t);return s&&Ge(e,"delete",t,void 0),i}function vi(){const t=V(this),e=t.size!==0,n=t.clear();return e&&Ge(t,"clear",void 0,void 0),n}function Kn(t,e){return function(r,s){const i=this,o=i.__v_raw,a=V(o),c=e?Fs:t?Hs:In;return!t&&me(a,"iterate",Tt),o.forEach((l,u)=>r.call(s,c(l),c(u),i))}}function qn(t,e,n){return function(...r){const s=this.__v_raw,i=V(s),o=jt(i),a=t==="entries"||t===Symbol.iterator&&o,c=t==="keys"&&o,l=s[t](...r),u=n?Fs:e?Hs:In;return!e&&me(i,"iterate",c?os:Tt),{next(){const{value:h,done:g}=l.next();return g?{value:h,done:g}:{value:a?[u(h[0]),u(h[1])]:u(h),done:g}},[Symbol.iterator](){return this}}}}function et(t){return function(...e){return t==="delete"?!1:this}}function ml(){const t={get(i){return Wn(this,i)},get size(){return zn(this)},has:Vn,add:gi,set:mi,delete:_i,clear:vi,forEach:Kn(!1,!1)},e={get(i){return Wn(this,i,!1,!0)},get size(){return zn(this)},has:Vn,add:gi,set:mi,delete:_i,clear:vi,forEach:Kn(!1,!0)},n={get(i){return Wn(this,i,!0)},get size(){return zn(this,!0)},has(i){return Vn.call(this,i,!0)},add:et("add"),set:et("set"),delete:et("delete"),clear:et("clear"),forEach:Kn(!0,!1)},r={get(i){return Wn(this,i,!0,!0)},get size(){return zn(this,!0)},has(i){return Vn.call(this,i,!0)},add:et("add"),set:et("set"),delete:et("delete"),clear:et("clear"),forEach:Kn(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(i=>{t[i]=qn(i,!1,!1),n[i]=qn(i,!0,!1),e[i]=qn(i,!1,!0),r[i]=qn(i,!0,!0)}),[t,n,e,r]}const[_l,vl,yl,bl]=ml();function Bs(t,e){const n=e?t?bl:yl:t?vl:_l;return(r,s,i)=>s==="__v_isReactive"?!t:s==="__v_isReadonly"?t:s==="__v_raw"?r:Reflect.get(W(n,s)&&s in r?n:r,s,i)}const El={get:Bs(!1,!1)},Il={get:Bs(!1,!0)},wl={get:Bs(!0,!1)},Go=new WeakMap,Jo=new WeakMap,Yo=new WeakMap,Tl=new WeakMap;function Rl(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Cl(t){return t.__v_skip||!Object.isExtensible(t)?0:Rl(Wc(t))}function Mn(t){return Jt(t)?t:$s(t,!1,qo,El,Go)}function Sl(t){return $s(t,!1,gl,Il,Jo)}function Xo(t){return $s(t,!0,pl,wl,Yo)}function $s(t,e,n,r,s){if(!Z(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const i=s.get(t);if(i)return i;const o=Cl(t);if(o===0)return t;const a=new Proxy(t,o===2?r:n);return s.set(t,a),a}function Wt(t){return Jt(t)?Wt(t.__v_raw):!!(t&&t.__v_isReactive)}function Jt(t){return!!(t&&t.__v_isReadonly)}function ar(t){return!!(t&&t.__v_isShallow)}function Qo(t){return Wt(t)||Jt(t)}function V(t){const e=t&&t.__v_raw;return e?V(e):t}function Zo(t){return or(t,"__v_skip",!0),t}const In=t=>Z(t)?Mn(t):t,Hs=t=>Z(t)?Xo(t):t;function ea(t){ut&&Ce&&(t=V(t),Vo(t.dep||(t.dep=xs())))}function ta(t,e){t=V(t);const n=t.dep;n&&as(n)}function ue(t){return!!(t&&t.__v_isRef===!0)}function na(t){return ra(t,!1)}function Al(t){return ra(t,!0)}function ra(t,e){return ue(t)?t:new Pl(t,e)}class Pl{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:V(e),this._value=n?e:In(e)}get value(){return ea(this),this._value}set value(e){const n=this.__v_isShallow||ar(e)||Jt(e);e=n?e:V(e),En(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:In(e),ta(this))}}function Vt(t){return ue(t)?t.value:t}const Ol={get:(t,e,n)=>Vt(Reflect.get(t,e,n)),set:(t,e,n,r)=>{const s=t[e];return ue(s)&&!ue(n)?(s.value=n,!0):Reflect.set(t,e,n,r)}};function sa(t){return Wt(t)?t:new Proxy(t,Ol)}class kl{constructor(e,n,r,s){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this._dirty=!0,this.effect=new Ls(e,()=>{this._dirty||(this._dirty=!0,ta(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!s,this.__v_isReadonly=r}get value(){const e=V(this);return ea(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}function Nl(t,e,n=!1){let r,s;const i=$(t);return i?(r=t,s=Ae):(r=t.get,s=t.set),new kl(r,s,i||!s,n)}function ft(t,e,n,r){let s;try{s=r?t(...r):t()}catch(i){Cr(i,e,n)}return s}function Pe(t,e,n,r){if($(t)){const i=ft(t,e,n,r);return i&&Lo(i)&&i.catch(o=>{Cr(o,e,n)}),i}const s=[];for(let i=0;i<t.length;i++)s.push(Pe(t[i],e,n,r));return s}function Cr(t,e,n,r=!0){const s=e?e.vnode:null;if(e){let i=e.parent;const o=e.proxy,a=n;for(;i;){const l=i.ec;if(l){for(let u=0;u<l.length;u++)if(l[u](t,o,a)===!1)return}i=i.parent}const c=e.appContext.config.errorHandler;if(c){ft(c,null,10,[t,o,a]);return}}Dl(t,n,s,r)}function Dl(t,e,n,r=!0){console.error(t)}let wn=!1,cs=!1;const le=[];let Be=0;const zt=[];let ze=null,bt=0;const ia=Promise.resolve();let js=null;function oa(t){const e=js||ia;return t?e.then(this?t.bind(this):t):e}function Ml(t){let e=Be+1,n=le.length;for(;e<n;){const r=e+n>>>1;Tn(le[r])<t?e=r+1:n=r}return e}function Ws(t){(!le.length||!le.includes(t,wn&&t.allowRecurse?Be+1:Be))&&(t.id==null?le.push(t):le.splice(Ml(t.id),0,t),aa())}function aa(){!wn&&!cs&&(cs=!0,js=ia.then(la))}function xl(t){const e=le.indexOf(t);e>Be&&le.splice(e,1)}function Ll(t){F(t)?zt.push(...t):(!ze||!ze.includes(t,t.allowRecurse?bt+1:bt))&&zt.push(t),aa()}function yi(t,e=wn?Be+1:0){for(;e<le.length;e++){const n=le[e];n&&n.pre&&(le.splice(e,1),e--,n())}}function ca(t){if(zt.length){const e=[...new Set(zt)];if(zt.length=0,ze){ze.push(...e);return}for(ze=e,ze.sort((n,r)=>Tn(n)-Tn(r)),bt=0;bt<ze.length;bt++)ze[bt]();ze=null,bt=0}}const Tn=t=>t.id==null?1/0:t.id,Ul=(t,e)=>{const n=Tn(t)-Tn(e);if(n===0){if(t.pre&&!e.pre)return-1;if(e.pre&&!t.pre)return 1}return n};function la(t){cs=!1,wn=!0,le.sort(Ul);const e=Ae;try{for(Be=0;Be<le.length;Be++){const n=le[Be];n&&n.active!==!1&&ft(n,null,14)}}finally{Be=0,le.length=0,ca(),wn=!1,js=null,(le.length||zt.length)&&la()}}function Fl(t,e,...n){if(t.isUnmounted)return;const r=t.vnode.props||Q;let s=n;const i=e.startsWith("update:"),o=i&&e.slice(7);if(o&&o in r){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:h,trim:g}=r[u]||Q;g&&(s=n.map(y=>se(y)?y.trim():y)),h&&(s=n.map(ns))}let a,c=r[a=Fr(e)]||r[a=Fr(je(e))];!c&&i&&(c=r[a=Fr(tn(e))]),c&&Pe(c,t,6,s);const l=r[a+"Once"];if(l){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,Pe(l,t,6,s)}}function ua(t,e,n=!1){const r=e.emitsCache,s=r.get(t);if(s!==void 0)return s;const i=t.emits;let o={},a=!1;if(!$(t)){const c=l=>{const u=ua(l,e,!0);u&&(a=!0,oe(o,u))};!n&&e.mixins.length&&e.mixins.forEach(c),t.extends&&c(t.extends),t.mixins&&t.mixins.forEach(c)}return!i&&!a?(Z(t)&&r.set(t,null),null):(F(i)?i.forEach(c=>o[c]=null):oe(o,i),Z(t)&&r.set(t,o),o)}function Sr(t,e){return!t||!Er(e)?!1:(e=e.slice(2).replace(/Once$/,""),W(t,e[0].toLowerCase()+e.slice(1))||W(t,tn(e))||W(t,e))}let Ee=null,Ar=null;function cr(t){const e=Ee;return Ee=t,Ar=t&&t.type.__scopeId||null,e}function Bl(t){Ar=t}function $l(){Ar=null}function Ut(t,e=Ee,n){if(!e||t._n)return t;const r=(...s)=>{r._d&&ki(-1);const i=cr(e);let o;try{o=t(...s)}finally{cr(i),r._d&&ki(1)}return o};return r._n=!0,r._c=!0,r._d=!0,r}function Br(t){const{type:e,vnode:n,proxy:r,withProxy:s,props:i,propsOptions:[o],slots:a,attrs:c,emit:l,render:u,renderCache:h,data:g,setupState:y,ctx:S,inheritAttrs:P}=t;let L,k;const M=cr(t);try{if(n.shapeFlag&4){const x=s||r;L=Fe(u.call(x,x,h,i,y,g,S)),k=c}else{const x=e;L=Fe(x.length>1?x(i,{attrs:c,slots:a,emit:l}):x(i,null)),k=e.props?c:Hl(c)}}catch(x){_n.length=0,Cr(x,t,1),L=re(St)}let j=L;if(k&&P!==!1){const x=Object.keys(k),{shapeFlag:te}=j;x.length&&te&7&&(o&&x.some(Ps)&&(k=jl(k,o)),j=Yt(j,k))}return n.dirs&&(j=Yt(j),j.dirs=j.dirs?j.dirs.concat(n.dirs):n.dirs),n.transition&&(j.transition=n.transition),L=j,cr(M),L}const Hl=t=>{let e;for(const n in t)(n==="class"||n==="style"||Er(n))&&((e||(e={}))[n]=t[n]);return e},jl=(t,e)=>{const n={};for(const r in t)(!Ps(r)||!(r.slice(9)in e))&&(n[r]=t[r]);return n};function Wl(t,e,n){const{props:r,children:s,component:i}=t,{props:o,children:a,patchFlag:c}=e,l=i.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return r?bi(r,o,l):!!o;if(c&8){const u=e.dynamicProps;for(let h=0;h<u.length;h++){const g=u[h];if(o[g]!==r[g]&&!Sr(l,g))return!0}}}else return(s||a)&&(!a||!a.$stable)?!0:r===o?!1:r?o?bi(r,o,l):!0:!!o;return!1}function bi(t,e,n){const r=Object.keys(e);if(r.length!==Object.keys(t).length)return!0;for(let s=0;s<r.length;s++){const i=r[s];if(e[i]!==t[i]&&!Sr(n,i))return!0}return!1}function Vl({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const zl=t=>t.__isSuspense;function Kl(t,e){e&&e.pendingBranch?F(t)?e.effects.push(...t):e.effects.push(t):Ll(t)}const Gn={};function Qn(t,e,n){return fa(t,e,n)}function fa(t,e,{immediate:n,deep:r,flush:s,onTrack:i,onTrigger:o}=Q){var a;const c=el()===((a=ae)==null?void 0:a.scope)?ae:null;let l,u=!1,h=!1;if(ue(t)?(l=()=>t.value,u=ar(t)):Wt(t)?(l=()=>t,r=!0):F(t)?(h=!0,u=t.some(x=>Wt(x)||ar(x)),l=()=>t.map(x=>{if(ue(x))return x.value;if(Wt(x))return It(x);if($(x))return ft(x,c,2)})):$(t)?e?l=()=>ft(t,c,2):l=()=>{if(!(c&&c.isUnmounted))return g&&g(),Pe(t,c,3,[y])}:l=Ae,e&&r){const x=l;l=()=>It(x())}let g,y=x=>{g=M.onStop=()=>{ft(x,c,4)}},S;if(Cn)if(y=Ae,e?n&&Pe(e,c,3,[l(),h?[]:void 0,y]):l(),s==="sync"){const x=$u();S=x.__watcherHandles||(x.__watcherHandles=[])}else return Ae;let P=h?new Array(t.length).fill(Gn):Gn;const L=()=>{if(M.active)if(e){const x=M.run();(r||u||(h?x.some((te,ne)=>En(te,P[ne])):En(x,P)))&&(g&&g(),Pe(e,c,3,[x,P===Gn?void 0:h&&P[0]===Gn?[]:P,y]),P=x)}else M.run()};L.allowRecurse=!!e;let k;s==="sync"?k=L:s==="post"?k=()=>pe(L,c&&c.suspense):(L.pre=!0,c&&(L.id=c.uid),k=()=>Ws(L));const M=new Ls(l,k);e?n?L():P=M.run():s==="post"?pe(M.run.bind(M),c&&c.suspense):M.run();const j=()=>{M.stop(),c&&c.scope&&Os(c.scope.effects,M)};return S&&S.push(j),j}function ql(t,e,n){const r=this.proxy,s=se(t)?t.includes(".")?da(r,t):()=>r[t]:t.bind(r,r);let i;$(e)?i=e:(i=e.handler,n=e);const o=ae;Xt(this);const a=fa(s,i.bind(r),n);return o?Xt(o):Rt(),a}function da(t,e){const n=e.split(".");return()=>{let r=t;for(let s=0;s<n.length&&r;s++)r=r[n[s]];return r}}function It(t,e){if(!Z(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),ue(t))It(t.value,e);else if(F(t))for(let n=0;n<t.length;n++)It(t[n],e);else if(xo(t)||jt(t))t.forEach(n=>{It(n,e)});else if(Fo(t))for(const n in t)It(t[n],e);return t}function pm(t,e){const n=Ee;if(n===null)return t;const r=Nr(n)||n.proxy,s=t.dirs||(t.dirs=[]);for(let i=0;i<e.length;i++){let[o,a,c,l=Q]=e[i];o&&($(o)&&(o={mounted:o,updated:o}),o.deep&&It(a),s.push({dir:o,instance:r,value:a,oldValue:void 0,arg:c,modifiers:l}))}return t}function _t(t,e,n,r){const s=t.dirs,i=e&&e.dirs;for(let o=0;o<s.length;o++){const a=s[o];i&&(a.oldValue=i[o].value);let c=a.dir[r];c&&(nn(),Pe(c,n,8,[t.el,a,t,e]),rn())}}function ha(t,e){return $(t)?(()=>oe({name:t.name},e,{setup:t}))():t}const Zn=t=>!!t.type.__asyncLoader,pa=t=>t.type.__isKeepAlive;function Gl(t,e){ga(t,"a",e)}function Jl(t,e){ga(t,"da",e)}function ga(t,e,n=ae){const r=t.__wdc||(t.__wdc=()=>{let s=n;for(;s;){if(s.isDeactivated)return;s=s.parent}return t()});if(Pr(e,r,n),n){let s=n.parent;for(;s&&s.parent;)pa(s.parent.vnode)&&Yl(r,e,n,s),s=s.parent}}function Yl(t,e,n,r){const s=Pr(e,t,r,!0);_a(()=>{Os(r[e],s)},n)}function Pr(t,e,n=ae,r=!1){if(n){const s=n[t]||(n[t]=[]),i=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;nn(),Xt(n);const a=Pe(e,n,t,o);return Rt(),rn(),a});return r?s.unshift(i):s.push(i),i}}const Ye=t=>(e,n=ae)=>(!Cn||t==="sp")&&Pr(t,(...r)=>e(...r),n),Xl=Ye("bm"),ma=Ye("m"),Ql=Ye("bu"),Zl=Ye("u"),eu=Ye("bum"),_a=Ye("um"),tu=Ye("sp"),nu=Ye("rtg"),ru=Ye("rtc");function su(t,e=ae){Pr("ec",t,e)}const va="components";function Ei(t,e){return ou(va,t,!0,e)||t}const iu=Symbol.for("v-ndc");function ou(t,e,n=!0,r=!1){const s=Ee||ae;if(s){const i=s.type;if(t===va){const a=Uu(i,!1);if(a&&(a===e||a===je(e)||a===Tr(je(e))))return i}const o=Ii(s[t]||i[t],e)||Ii(s.appContext[t],e);return!o&&r?i:o}}function Ii(t,e){return t&&(t[e]||t[je(e)]||t[Tr(je(e))])}function gm(t,e,n,r){let s;const i=n&&n[r];if(F(t)||se(t)){s=new Array(t.length);for(let o=0,a=t.length;o<a;o++)s[o]=e(t[o],o,void 0,i&&i[o])}else if(typeof t=="number"){s=new Array(t);for(let o=0;o<t;o++)s[o]=e(o+1,o,void 0,i&&i[o])}else if(Z(t))if(t[Symbol.iterator])s=Array.from(t,(o,a)=>e(o,a,void 0,i&&i[a]));else{const o=Object.keys(t);s=new Array(o.length);for(let a=0,c=o.length;a<c;a++){const l=o[a];s[a]=e(t[l],l,a,i&&i[a])}}else s=[];return n&&(n[r]=s),s}const ls=t=>t?Pa(t)?Nr(t)||t.proxy:ls(t.parent):null,mn=oe(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>ls(t.parent),$root:t=>ls(t.root),$emit:t=>t.emit,$options:t=>Vs(t),$forceUpdate:t=>t.f||(t.f=()=>Ws(t.update)),$nextTick:t=>t.n||(t.n=oa.bind(t.proxy)),$watch:t=>ql.bind(t)}),$r=(t,e)=>t!==Q&&!t.__isScriptSetup&&W(t,e),au={get({_:t},e){const{ctx:n,setupState:r,data:s,props:i,accessCache:o,type:a,appContext:c}=t;let l;if(e[0]!=="$"){const y=o[e];if(y!==void 0)switch(y){case 1:return r[e];case 2:return s[e];case 4:return n[e];case 3:return i[e]}else{if($r(r,e))return o[e]=1,r[e];if(s!==Q&&W(s,e))return o[e]=2,s[e];if((l=t.propsOptions[0])&&W(l,e))return o[e]=3,i[e];if(n!==Q&&W(n,e))return o[e]=4,n[e];us&&(o[e]=0)}}const u=mn[e];let h,g;if(u)return e==="$attrs"&&me(t,"get",e),u(t);if((h=a.__cssModules)&&(h=h[e]))return h;if(n!==Q&&W(n,e))return o[e]=4,n[e];if(g=c.config.globalProperties,W(g,e))return g[e]},set({_:t},e,n){const{data:r,setupState:s,ctx:i}=t;return $r(s,e)?(s[e]=n,!0):r!==Q&&W(r,e)?(r[e]=n,!0):W(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(i[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:r,appContext:s,propsOptions:i}},o){let a;return!!n[o]||t!==Q&&W(t,o)||$r(e,o)||(a=i[0])&&W(a,o)||W(r,o)||W(mn,o)||W(s.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:W(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};function wi(t){return F(t)?t.reduce((e,n)=>(e[n]=null,e),{}):t}let us=!0;function cu(t){const e=Vs(t),n=t.proxy,r=t.ctx;us=!1,e.beforeCreate&&Ti(e.beforeCreate,t,"bc");const{data:s,computed:i,methods:o,watch:a,provide:c,inject:l,created:u,beforeMount:h,mounted:g,beforeUpdate:y,updated:S,activated:P,deactivated:L,beforeDestroy:k,beforeUnmount:M,destroyed:j,unmounted:x,render:te,renderTracked:ne,renderTriggered:_e,errorCaptured:we,serverPrefetch:Ne,expose:ye,inheritAttrs:Qe,components:mt,directives:De,filters:cn}=e;if(l&&lu(l,r,null),o)for(const J in o){const z=o[J];$(z)&&(r[J]=z.bind(n))}if(s){const J=s.call(n,n);Z(J)&&(t.data=Mn(J))}if(us=!0,i)for(const J in i){const z=i[J],We=$(z)?z.bind(n,n):$(z.get)?z.get.bind(n,n):Ae,Ze=!$(z)&&$(z.set)?z.set.bind(n):Ae,Me=be({get:We,set:Ze});Object.defineProperty(r,J,{enumerable:!0,configurable:!0,get:()=>Me.value,set:he=>Me.value=he})}if(a)for(const J in a)ya(a[J],r,n,J);if(c){const J=$(c)?c.call(n):c;Reflect.ownKeys(J).forEach(z=>{er(z,J[z])})}u&&Ti(u,t,"c");function ie(J,z){F(z)?z.forEach(We=>J(We.bind(n))):z&&J(z.bind(n))}if(ie(Xl,h),ie(ma,g),ie(Ql,y),ie(Zl,S),ie(Gl,P),ie(Jl,L),ie(su,we),ie(ru,ne),ie(nu,_e),ie(eu,M),ie(_a,x),ie(tu,Ne),F(ye))if(ye.length){const J=t.exposed||(t.exposed={});ye.forEach(z=>{Object.defineProperty(J,z,{get:()=>n[z],set:We=>n[z]=We})})}else t.exposed||(t.exposed={});te&&t.render===Ae&&(t.render=te),Qe!=null&&(t.inheritAttrs=Qe),mt&&(t.components=mt),De&&(t.directives=De)}function lu(t,e,n=Ae){F(t)&&(t=fs(t));for(const r in t){const s=t[r];let i;Z(s)?"default"in s?i=Oe(s.from||r,s.default,!0):i=Oe(s.from||r):i=Oe(s),ue(i)?Object.defineProperty(e,r,{enumerable:!0,configurable:!0,get:()=>i.value,set:o=>i.value=o}):e[r]=i}}function Ti(t,e,n){Pe(F(t)?t.map(r=>r.bind(e.proxy)):t.bind(e.proxy),e,n)}function ya(t,e,n,r){const s=r.includes(".")?da(n,r):()=>n[r];if(se(t)){const i=e[t];$(i)&&Qn(s,i)}else if($(t))Qn(s,t.bind(n));else if(Z(t))if(F(t))t.forEach(i=>ya(i,e,n,r));else{const i=$(t.handler)?t.handler.bind(n):e[t.handler];$(i)&&Qn(s,i,t)}}function Vs(t){const e=t.type,{mixins:n,extends:r}=e,{mixins:s,optionsCache:i,config:{optionMergeStrategies:o}}=t.appContext,a=i.get(e);let c;return a?c=a:!s.length&&!n&&!r?c=e:(c={},s.length&&s.forEach(l=>lr(c,l,o,!0)),lr(c,e,o)),Z(e)&&i.set(e,c),c}function lr(t,e,n,r=!1){const{mixins:s,extends:i}=e;i&&lr(t,i,n,!0),s&&s.forEach(o=>lr(t,o,n,!0));for(const o in e)if(!(r&&o==="expose")){const a=uu[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const uu={data:Ri,props:Ci,emits:Ci,methods:hn,computed:hn,beforeCreate:de,created:de,beforeMount:de,mounted:de,beforeUpdate:de,updated:de,beforeDestroy:de,beforeUnmount:de,destroyed:de,unmounted:de,activated:de,deactivated:de,errorCaptured:de,serverPrefetch:de,components:hn,directives:hn,watch:du,provide:Ri,inject:fu};function Ri(t,e){return e?t?function(){return oe($(t)?t.call(this,this):t,$(e)?e.call(this,this):e)}:e:t}function fu(t,e){return hn(fs(t),fs(e))}function fs(t){if(F(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function de(t,e){return t?[...new Set([].concat(t,e))]:e}function hn(t,e){return t?oe(Object.create(null),t,e):e}function Ci(t,e){return t?F(t)&&F(e)?[...new Set([...t,...e])]:oe(Object.create(null),wi(t),wi(e??{})):e}function du(t,e){if(!t)return e;if(!e)return t;const n=oe(Object.create(null),t);for(const r in e)n[r]=de(t[r],e[r]);return n}function ba(){return{app:null,config:{isNativeTag:$c,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let hu=0;function pu(t,e){return function(r,s=null){$(r)||(r=oe({},r)),s!=null&&!Z(s)&&(s=null);const i=ba(),o=new Set;let a=!1;const c=i.app={_uid:hu++,_component:r,_props:s,_container:null,_context:i,_instance:null,version:Hu,get config(){return i.config},set config(l){},use(l,...u){return o.has(l)||(l&&$(l.install)?(o.add(l),l.install(c,...u)):$(l)&&(o.add(l),l(c,...u))),c},mixin(l){return i.mixins.includes(l)||i.mixins.push(l),c},component(l,u){return u?(i.components[l]=u,c):i.components[l]},directive(l,u){return u?(i.directives[l]=u,c):i.directives[l]},mount(l,u,h){if(!a){const g=re(r,s);return g.appContext=i,u&&e?e(g,l):t(g,l,h),a=!0,c._container=l,l.__vue_app__=c,Nr(g.component)||g.component.proxy}},unmount(){a&&(t(null,c._container),delete c._container.__vue_app__)},provide(l,u){return i.provides[l]=u,c},runWithContext(l){ur=c;try{return l()}finally{ur=null}}};return c}}let ur=null;function er(t,e){if(ae){let n=ae.provides;const r=ae.parent&&ae.parent.provides;r===n&&(n=ae.provides=Object.create(r)),n[t]=e}}function Oe(t,e,n=!1){const r=ae||Ee;if(r||ur){const s=r?r.parent==null?r.vnode.appContext&&r.vnode.appContext.provides:r.parent.provides:ur._context.provides;if(s&&t in s)return s[t];if(arguments.length>1)return n&&$(e)?e.call(r&&r.proxy):e}}function gu(t,e,n,r=!1){const s={},i={};or(i,kr,1),t.propsDefaults=Object.create(null),Ea(t,e,s,i);for(const o in t.propsOptions[0])o in s||(s[o]=void 0);n?t.props=r?s:Sl(s):t.type.props?t.props=s:t.props=i,t.attrs=i}function mu(t,e,n,r){const{props:s,attrs:i,vnode:{patchFlag:o}}=t,a=V(s),[c]=t.propsOptions;let l=!1;if((r||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let h=0;h<u.length;h++){let g=u[h];if(Sr(t.emitsOptions,g))continue;const y=e[g];if(c)if(W(i,g))y!==i[g]&&(i[g]=y,l=!0);else{const S=je(g);s[S]=ds(c,a,S,y,t,!1)}else y!==i[g]&&(i[g]=y,l=!0)}}}else{Ea(t,e,s,i)&&(l=!0);let u;for(const h in a)(!e||!W(e,h)&&((u=tn(h))===h||!W(e,u)))&&(c?n&&(n[h]!==void 0||n[u]!==void 0)&&(s[h]=ds(c,a,h,void 0,t,!0)):delete s[h]);if(i!==a)for(const h in i)(!e||!W(e,h))&&(delete i[h],l=!0)}l&&Ge(t,"set","$attrs")}function Ea(t,e,n,r){const[s,i]=t.propsOptions;let o=!1,a;if(e)for(let c in e){if(Yn(c))continue;const l=e[c];let u;s&&W(s,u=je(c))?!i||!i.includes(u)?n[u]=l:(a||(a={}))[u]=l:Sr(t.emitsOptions,c)||(!(c in r)||l!==r[c])&&(r[c]=l,o=!0)}if(i){const c=V(n),l=a||Q;for(let u=0;u<i.length;u++){const h=i[u];n[h]=ds(s,c,h,l[h],t,!W(l,h))}}return o}function ds(t,e,n,r,s,i){const o=t[n];if(o!=null){const a=W(o,"default");if(a&&r===void 0){const c=o.default;if(o.type!==Function&&!o.skipFactory&&$(c)){const{propsDefaults:l}=s;n in l?r=l[n]:(Xt(s),r=l[n]=c.call(null,e),Rt())}else r=c}o[0]&&(i&&!a?r=!1:o[1]&&(r===""||r===tn(n))&&(r=!0))}return r}function Ia(t,e,n=!1){const r=e.propsCache,s=r.get(t);if(s)return s;const i=t.props,o={},a=[];let c=!1;if(!$(t)){const u=h=>{c=!0;const[g,y]=Ia(h,e,!0);oe(o,g),y&&a.push(...y)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!i&&!c)return Z(t)&&r.set(t,Ht),Ht;if(F(i))for(let u=0;u<i.length;u++){const h=je(i[u]);Si(h)&&(o[h]=Q)}else if(i)for(const u in i){const h=je(u);if(Si(h)){const g=i[u],y=o[h]=F(g)||$(g)?{type:g}:oe({},g);if(y){const S=Oi(Boolean,y.type),P=Oi(String,y.type);y[0]=S>-1,y[1]=P<0||S<P,(S>-1||W(y,"default"))&&a.push(h)}}}const l=[o,a];return Z(t)&&r.set(t,l),l}function Si(t){return t[0]!=="$"}function Ai(t){const e=t&&t.toString().match(/^\s*(function|class) (\w+)/);return e?e[2]:t===null?"null":""}function Pi(t,e){return Ai(t)===Ai(e)}function Oi(t,e){return F(e)?e.findIndex(n=>Pi(n,t)):$(e)&&Pi(e,t)?0:-1}const wa=t=>t[0]==="_"||t==="$stable",zs=t=>F(t)?t.map(Fe):[Fe(t)],_u=(t,e,n)=>{if(e._n)return e;const r=Ut((...s)=>zs(e(...s)),n);return r._c=!1,r},Ta=(t,e,n)=>{const r=t._ctx;for(const s in t){if(wa(s))continue;const i=t[s];if($(i))e[s]=_u(s,i,r);else if(i!=null){const o=zs(i);e[s]=()=>o}}},Ra=(t,e)=>{const n=zs(e);t.slots.default=()=>n},vu=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=V(e),or(e,"_",n)):Ta(e,t.slots={})}else t.slots={},e&&Ra(t,e);or(t.slots,kr,1)},yu=(t,e,n)=>{const{vnode:r,slots:s}=t;let i=!0,o=Q;if(r.shapeFlag&32){const a=e._;a?n&&a===1?i=!1:(oe(s,e),!n&&a===1&&delete s._):(i=!e.$stable,Ta(e,s)),o=e}else e&&(Ra(t,e),o={default:1});if(i)for(const a in s)!wa(a)&&!(a in o)&&delete s[a]};function hs(t,e,n,r,s=!1){if(F(t)){t.forEach((g,y)=>hs(g,e&&(F(e)?e[y]:e),n,r,s));return}if(Zn(r)&&!s)return;const i=r.shapeFlag&4?Nr(r.component)||r.component.proxy:r.el,o=s?null:i,{i:a,r:c}=t,l=e&&e.r,u=a.refs===Q?a.refs={}:a.refs,h=a.setupState;if(l!=null&&l!==c&&(se(l)?(u[l]=null,W(h,l)&&(h[l]=null)):ue(l)&&(l.value=null)),$(c))ft(c,a,12,[o,u]);else{const g=se(c),y=ue(c);if(g||y){const S=()=>{if(t.f){const P=g?W(h,c)?h[c]:u[c]:c.value;s?F(P)&&Os(P,i):F(P)?P.includes(i)||P.push(i):g?(u[c]=[i],W(h,c)&&(h[c]=u[c])):(c.value=[i],t.k&&(u[t.k]=c.value))}else g?(u[c]=o,W(h,c)&&(h[c]=o)):y&&(c.value=o,t.k&&(u[t.k]=o))};o?(S.id=-1,pe(S,n)):S()}}}const pe=Kl;function bu(t){return Eu(t)}function Eu(t,e){const n=rs();n.__VUE__=!0;const{insert:r,remove:s,patchProp:i,createElement:o,createText:a,createComment:c,setText:l,setElementText:u,parentNode:h,nextSibling:g,setScopeId:y=Ae,insertStaticContent:S}=t,P=(f,d,p,m=null,v=null,b=null,R=!1,I=null,w=!!d.dynamicChildren)=>{if(f===d)return;f&&!un(f,d)&&(m=_(f),he(f,v,b,!0),f=null),d.patchFlag===-2&&(w=!1,d.dynamicChildren=null);const{type:E,ref:N,shapeFlag:A}=d;switch(E){case Or:L(f,d,p,m);break;case St:k(f,d,p,m);break;case Hr:f==null&&M(d,p,m,R);break;case Ue:mt(f,d,p,m,v,b,R,I,w);break;default:A&1?te(f,d,p,m,v,b,R,I,w):A&6?De(f,d,p,m,v,b,R,I,w):(A&64||A&128)&&E.process(f,d,p,m,v,b,R,I,w,T)}N!=null&&v&&hs(N,f&&f.ref,b,d||f,!d)},L=(f,d,p,m)=>{if(f==null)r(d.el=a(d.children),p,m);else{const v=d.el=f.el;d.children!==f.children&&l(v,d.children)}},k=(f,d,p,m)=>{f==null?r(d.el=c(d.children||""),p,m):d.el=f.el},M=(f,d,p,m)=>{[f.el,f.anchor]=S(f.children,d,p,m,f.el,f.anchor)},j=({el:f,anchor:d},p,m)=>{let v;for(;f&&f!==d;)v=g(f),r(f,p,m),f=v;r(d,p,m)},x=({el:f,anchor:d})=>{let p;for(;f&&f!==d;)p=g(f),s(f),f=p;s(d)},te=(f,d,p,m,v,b,R,I,w)=>{R=R||d.type==="svg",f==null?ne(d,p,m,v,b,R,I,w):Ne(f,d,v,b,R,I,w)},ne=(f,d,p,m,v,b,R,I)=>{let w,E;const{type:N,props:A,shapeFlag:D,transition:B,dirs:H}=f;if(w=f.el=o(f.type,b,A&&A.is,A),D&8?u(w,f.children):D&16&&we(f.children,w,null,m,v,b&&N!=="foreignObject",R,I),H&&_t(f,null,m,"created"),_e(w,f,f.scopeId,R,m),A){for(const G in A)G!=="value"&&!Yn(G)&&i(w,G,null,A[G],b,f.children,m,v,ce);"value"in A&&i(w,"value",null,A.value),(E=A.onVnodeBeforeMount)&&Le(E,m,f)}H&&_t(f,null,m,"beforeMount");const X=(!v||v&&!v.pendingBranch)&&B&&!B.persisted;X&&B.beforeEnter(w),r(w,d,p),((E=A&&A.onVnodeMounted)||X||H)&&pe(()=>{E&&Le(E,m,f),X&&B.enter(w),H&&_t(f,null,m,"mounted")},v)},_e=(f,d,p,m,v)=>{if(p&&y(f,p),m)for(let b=0;b<m.length;b++)y(f,m[b]);if(v){let b=v.subTree;if(d===b){const R=v.vnode;_e(f,R,R.scopeId,R.slotScopeIds,v.parent)}}},we=(f,d,p,m,v,b,R,I,w=0)=>{for(let E=w;E<f.length;E++){const N=f[E]=I?st(f[E]):Fe(f[E]);P(null,N,d,p,m,v,b,R,I)}},Ne=(f,d,p,m,v,b,R)=>{const I=d.el=f.el;let{patchFlag:w,dynamicChildren:E,dirs:N}=d;w|=f.patchFlag&16;const A=f.props||Q,D=d.props||Q;let B;p&&vt(p,!1),(B=D.onVnodeBeforeUpdate)&&Le(B,p,d,f),N&&_t(d,f,p,"beforeUpdate"),p&&vt(p,!0);const H=v&&d.type!=="foreignObject";if(E?ye(f.dynamicChildren,E,I,p,m,H,b):R||z(f,d,I,null,p,m,H,b,!1),w>0){if(w&16)Qe(I,d,A,D,p,m,v);else if(w&2&&A.class!==D.class&&i(I,"class",null,D.class,v),w&4&&i(I,"style",A.style,D.style,v),w&8){const X=d.dynamicProps;for(let G=0;G<X.length;G++){const ee=X[G],Te=A[ee],xt=D[ee];(xt!==Te||ee==="value")&&i(I,ee,Te,xt,v,f.children,p,m,ce)}}w&1&&f.children!==d.children&&u(I,d.children)}else!R&&E==null&&Qe(I,d,A,D,p,m,v);((B=D.onVnodeUpdated)||N)&&pe(()=>{B&&Le(B,p,d,f),N&&_t(d,f,p,"updated")},m)},ye=(f,d,p,m,v,b,R)=>{for(let I=0;I<d.length;I++){const w=f[I],E=d[I],N=w.el&&(w.type===Ue||!un(w,E)||w.shapeFlag&70)?h(w.el):p;P(w,E,N,null,m,v,b,R,!0)}},Qe=(f,d,p,m,v,b,R)=>{if(p!==m){if(p!==Q)for(const I in p)!Yn(I)&&!(I in m)&&i(f,I,p[I],null,R,d.children,v,b,ce);for(const I in m){if(Yn(I))continue;const w=m[I],E=p[I];w!==E&&I!=="value"&&i(f,I,E,w,R,d.children,v,b,ce)}"value"in m&&i(f,"value",p.value,m.value)}},mt=(f,d,p,m,v,b,R,I,w)=>{const E=d.el=f?f.el:a(""),N=d.anchor=f?f.anchor:a("");let{patchFlag:A,dynamicChildren:D,slotScopeIds:B}=d;B&&(I=I?I.concat(B):B),f==null?(r(E,p,m),r(N,p,m),we(d.children,p,N,v,b,R,I,w)):A>0&&A&64&&D&&f.dynamicChildren?(ye(f.dynamicChildren,D,p,v,b,R,I),(d.key!=null||v&&d===v.subTree)&&Ca(f,d,!0)):z(f,d,p,N,v,b,R,I,w)},De=(f,d,p,m,v,b,R,I,w)=>{d.slotScopeIds=I,f==null?d.shapeFlag&512?v.ctx.activate(d,p,m,R,w):cn(d,p,m,v,b,R,w):Nt(f,d,w)},cn=(f,d,p,m,v,b,R)=>{const I=f.component=Nu(f,m,v);if(pa(f)&&(I.ctx.renderer=T),Du(I),I.asyncDep){if(v&&v.registerDep(I,ie),!f.el){const w=I.subTree=re(St);k(null,w,d,p)}return}ie(I,f,d,p,v,b,R)},Nt=(f,d,p)=>{const m=d.component=f.component;if(Wl(f,d,p))if(m.asyncDep&&!m.asyncResolved){J(m,d,p);return}else m.next=d,xl(m.update),m.update();else d.el=f.el,m.vnode=d},ie=(f,d,p,m,v,b,R)=>{const I=()=>{if(f.isMounted){let{next:N,bu:A,u:D,parent:B,vnode:H}=f,X=N,G;vt(f,!1),N?(N.el=H.el,J(f,N,R)):N=H,A&&Xn(A),(G=N.props&&N.props.onVnodeBeforeUpdate)&&Le(G,B,N,H),vt(f,!0);const ee=Br(f),Te=f.subTree;f.subTree=ee,P(Te,ee,h(Te.el),_(Te),f,v,b),N.el=ee.el,X===null&&Vl(f,ee.el),D&&pe(D,v),(G=N.props&&N.props.onVnodeUpdated)&&pe(()=>Le(G,B,N,H),v)}else{let N;const{el:A,props:D}=d,{bm:B,m:H,parent:X}=f,G=Zn(d);if(vt(f,!1),B&&Xn(B),!G&&(N=D&&D.onVnodeBeforeMount)&&Le(N,X,d),vt(f,!0),A&&K){const ee=()=>{f.subTree=Br(f),K(A,f.subTree,f,v,null)};G?d.type.__asyncLoader().then(()=>!f.isUnmounted&&ee()):ee()}else{const ee=f.subTree=Br(f);P(null,ee,p,m,f,v,b),d.el=ee.el}if(H&&pe(H,v),!G&&(N=D&&D.onVnodeMounted)){const ee=d;pe(()=>Le(N,X,ee),v)}(d.shapeFlag&256||X&&Zn(X.vnode)&&X.vnode.shapeFlag&256)&&f.a&&pe(f.a,v),f.isMounted=!0,d=p=m=null}},w=f.effect=new Ls(I,()=>Ws(E),f.scope),E=f.update=()=>w.run();E.id=f.uid,vt(f,!0),E()},J=(f,d,p)=>{d.component=f;const m=f.vnode.props;f.vnode=d,f.next=null,mu(f,d.props,m,p),yu(f,d.children,p),nn(),yi(),rn()},z=(f,d,p,m,v,b,R,I,w=!1)=>{const E=f&&f.children,N=f?f.shapeFlag:0,A=d.children,{patchFlag:D,shapeFlag:B}=d;if(D>0){if(D&128){Ze(E,A,p,m,v,b,R,I,w);return}else if(D&256){We(E,A,p,m,v,b,R,I,w);return}}B&8?(N&16&&ce(E,v,b),A!==E&&u(p,A)):N&16?B&16?Ze(E,A,p,m,v,b,R,I,w):ce(E,v,b,!0):(N&8&&u(p,""),B&16&&we(A,p,m,v,b,R,I,w))},We=(f,d,p,m,v,b,R,I,w)=>{f=f||Ht,d=d||Ht;const E=f.length,N=d.length,A=Math.min(E,N);let D;for(D=0;D<A;D++){const B=d[D]=w?st(d[D]):Fe(d[D]);P(f[D],B,p,null,v,b,R,I,w)}E>N?ce(f,v,b,!0,!1,A):we(d,p,m,v,b,R,I,w,A)},Ze=(f,d,p,m,v,b,R,I,w)=>{let E=0;const N=d.length;let A=f.length-1,D=N-1;for(;E<=A&&E<=D;){const B=f[E],H=d[E]=w?st(d[E]):Fe(d[E]);if(un(B,H))P(B,H,p,null,v,b,R,I,w);else break;E++}for(;E<=A&&E<=D;){const B=f[A],H=d[D]=w?st(d[D]):Fe(d[D]);if(un(B,H))P(B,H,p,null,v,b,R,I,w);else break;A--,D--}if(E>A){if(E<=D){const B=D+1,H=B<N?d[B].el:m;for(;E<=D;)P(null,d[E]=w?st(d[E]):Fe(d[E]),p,H,v,b,R,I,w),E++}}else if(E>D)for(;E<=A;)he(f[E],v,b,!0),E++;else{const B=E,H=E,X=new Map;for(E=H;E<=D;E++){const ve=d[E]=w?st(d[E]):Fe(d[E]);ve.key!=null&&X.set(ve.key,E)}let G,ee=0;const Te=D-H+1;let xt=!1,ci=0;const ln=new Array(Te);for(E=0;E<Te;E++)ln[E]=0;for(E=B;E<=A;E++){const ve=f[E];if(ee>=Te){he(ve,v,b,!0);continue}let xe;if(ve.key!=null)xe=X.get(ve.key);else for(G=H;G<=D;G++)if(ln[G-H]===0&&un(ve,d[G])){xe=G;break}xe===void 0?he(ve,v,b,!0):(ln[xe-H]=E+1,xe>=ci?ci=xe:xt=!0,P(ve,d[xe],p,null,v,b,R,I,w),ee++)}const li=xt?Iu(ln):Ht;for(G=li.length-1,E=Te-1;E>=0;E--){const ve=H+E,xe=d[ve],ui=ve+1<N?d[ve+1].el:m;ln[E]===0?P(null,xe,p,ui,v,b,R,I,w):xt&&(G<0||E!==li[G]?Me(xe,p,ui,2):G--)}}},Me=(f,d,p,m,v=null)=>{const{el:b,type:R,transition:I,children:w,shapeFlag:E}=f;if(E&6){Me(f.component.subTree,d,p,m);return}if(E&128){f.suspense.move(d,p,m);return}if(E&64){R.move(f,d,p,T);return}if(R===Ue){r(b,d,p);for(let A=0;A<w.length;A++)Me(w[A],d,p,m);r(f.anchor,d,p);return}if(R===Hr){j(f,d,p);return}if(m!==2&&E&1&&I)if(m===0)I.beforeEnter(b),r(b,d,p),pe(()=>I.enter(b),v);else{const{leave:A,delayLeave:D,afterLeave:B}=I,H=()=>r(b,d,p),X=()=>{A(b,()=>{H(),B&&B()})};D?D(b,H,X):X()}else r(b,d,p)},he=(f,d,p,m=!1,v=!1)=>{const{type:b,props:R,ref:I,children:w,dynamicChildren:E,shapeFlag:N,patchFlag:A,dirs:D}=f;if(I!=null&&hs(I,null,p,f,!0),N&256){d.ctx.deactivate(f);return}const B=N&1&&D,H=!Zn(f);let X;if(H&&(X=R&&R.onVnodeBeforeUnmount)&&Le(X,d,f),N&6)jn(f.component,p,m);else{if(N&128){f.suspense.unmount(p,m);return}B&&_t(f,null,d,"beforeUnmount"),N&64?f.type.remove(f,d,p,v,T,m):E&&(b!==Ue||A>0&&A&64)?ce(E,d,p,!1,!0):(b===Ue&&A&384||!v&&N&16)&&ce(w,d,p),m&&Dt(f)}(H&&(X=R&&R.onVnodeUnmounted)||B)&&pe(()=>{X&&Le(X,d,f),B&&_t(f,null,d,"unmounted")},p)},Dt=f=>{const{type:d,el:p,anchor:m,transition:v}=f;if(d===Ue){Mt(p,m);return}if(d===Hr){x(f);return}const b=()=>{s(p),v&&!v.persisted&&v.afterLeave&&v.afterLeave()};if(f.shapeFlag&1&&v&&!v.persisted){const{leave:R,delayLeave:I}=v,w=()=>R(p,b);I?I(f.el,b,w):w()}else b()},Mt=(f,d)=>{let p;for(;f!==d;)p=g(f),s(f),f=p;s(d)},jn=(f,d,p)=>{const{bum:m,scope:v,update:b,subTree:R,um:I}=f;m&&Xn(m),v.stop(),b&&(b.active=!1,he(R,f,d,p)),I&&pe(I,d),pe(()=>{f.isUnmounted=!0},d),d&&d.pendingBranch&&!d.isUnmounted&&f.asyncDep&&!f.asyncResolved&&f.suspenseId===d.pendingId&&(d.deps--,d.deps===0&&d.resolve())},ce=(f,d,p,m=!1,v=!1,b=0)=>{for(let R=b;R<f.length;R++)he(f[R],d,p,m,v)},_=f=>f.shapeFlag&6?_(f.component.subTree):f.shapeFlag&128?f.suspense.next():g(f.anchor||f.el),C=(f,d,p)=>{f==null?d._vnode&&he(d._vnode,null,null,!0):P(d._vnode||null,f,d,null,null,null,p),yi(),ca(),d._vnode=f},T={p:P,um:he,m:Me,r:Dt,mt:cn,mc:we,pc:z,pbc:ye,n:_,o:t};let O,K;return e&&([O,K]=e(T)),{render:C,hydrate:O,createApp:pu(C,O)}}function vt({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function Ca(t,e,n=!1){const r=t.children,s=e.children;if(F(r)&&F(s))for(let i=0;i<r.length;i++){const o=r[i];let a=s[i];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=s[i]=st(s[i]),a.el=o.el),n||Ca(o,a)),a.type===Or&&(a.el=o.el)}}function Iu(t){const e=t.slice(),n=[0];let r,s,i,o,a;const c=t.length;for(r=0;r<c;r++){const l=t[r];if(l!==0){if(s=n[n.length-1],t[s]<l){e[r]=s,n.push(r);continue}for(i=0,o=n.length-1;i<o;)a=i+o>>1,t[n[a]]<l?i=a+1:o=a;l<t[n[i]]&&(i>0&&(e[r]=n[i-1]),n[i]=r)}}for(i=n.length,o=n[i-1];i-- >0;)n[i]=o,o=e[o];return n}const wu=t=>t.__isTeleport,Ue=Symbol.for("v-fgt"),Or=Symbol.for("v-txt"),St=Symbol.for("v-cmt"),Hr=Symbol.for("v-stc"),_n=[];let Se=null;function ps(t=!1){_n.push(Se=t?null:[])}function Tu(){_n.pop(),Se=_n[_n.length-1]||null}let Rn=1;function ki(t){Rn+=t}function Sa(t){return t.dynamicChildren=Rn>0?Se||Ht:null,Tu(),Rn>0&&Se&&Se.push(t),t}function Ni(t,e,n,r,s,i){return Sa(ge(t,e,n,r,s,i,!0))}function Ru(t,e,n,r,s){return Sa(re(t,e,n,r,s,!0))}function gs(t){return t?t.__v_isVNode===!0:!1}function un(t,e){return t.type===e.type&&t.key===e.key}const kr="__vInternal",Aa=({key:t})=>t??null,tr=({ref:t,ref_key:e,ref_for:n})=>(typeof t=="number"&&(t=""+t),t!=null?se(t)||ue(t)||$(t)?{i:Ee,r:t,k:e,f:!!n}:t:null);function ge(t,e=null,n=null,r=0,s=null,i=t===Ue?0:1,o=!1,a=!1){const c={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&Aa(e),ref:e&&tr(e),scopeId:Ar,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:r,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:Ee};return a?(Ks(c,n),i&128&&t.normalize(c)):n&&(c.shapeFlag|=se(n)?8:16),Rn>0&&!o&&Se&&(c.patchFlag>0||i&6)&&c.patchFlag!==32&&Se.push(c),c}const re=Cu;function Cu(t,e=null,n=null,r=0,s=null,i=!1){if((!t||t===iu)&&(t=St),gs(t)){const a=Yt(t,e,!0);return n&&Ks(a,n),Rn>0&&!i&&Se&&(a.shapeFlag&6?Se[Se.indexOf(t)]=a:Se.push(a)),a.patchFlag|=-2,a}if(Fu(t)&&(t=t.__vccOpts),e){e=Su(e);let{class:a,style:c}=e;a&&!se(a)&&(e.class=Ms(a)),Z(c)&&(Qo(c)&&!F(c)&&(c=oe({},c)),e.style=Ds(c))}const o=se(t)?1:zl(t)?128:wu(t)?64:Z(t)?4:$(t)?2:0;return ge(t,e,n,r,s,o,i,!0)}function Su(t){return t?Qo(t)||kr in t?oe({},t):t:null}function Yt(t,e,n=!1){const{props:r,ref:s,patchFlag:i,children:o}=t,a=e?Pu(r||{},e):r;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&Aa(a),ref:e&&e.ref?n&&s?F(s)?s.concat(tr(e)):[s,tr(e)]:tr(e):s,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Ue?i===-1?16:i|16:i,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&Yt(t.ssContent),ssFallback:t.ssFallback&&Yt(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce}}function Ft(t=" ",e=0){return re(Or,null,t,e)}function Au(t="",e=!1){return e?(ps(),Ru(St,null,t)):re(St,null,t)}function Fe(t){return t==null||typeof t=="boolean"?re(St):F(t)?re(Ue,null,t.slice()):typeof t=="object"?st(t):re(Or,null,String(t))}function st(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:Yt(t)}function Ks(t,e){let n=0;const{shapeFlag:r}=t;if(e==null)e=null;else if(F(e))n=16;else if(typeof e=="object")if(r&65){const s=e.default;s&&(s._c&&(s._d=!1),Ks(t,s()),s._c&&(s._d=!0));return}else{n=32;const s=e._;!s&&!(kr in e)?e._ctx=Ee:s===3&&Ee&&(Ee.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else $(e)?(e={default:e,_ctx:Ee},n=32):(e=String(e),r&64?(n=16,e=[Ft(e)]):n=8);t.children=e,t.shapeFlag|=n}function Pu(...t){const e={};for(let n=0;n<t.length;n++){const r=t[n];for(const s in r)if(s==="class")e.class!==r.class&&(e.class=Ms([e.class,r.class]));else if(s==="style")e.style=Ds([e.style,r.style]);else if(Er(s)){const i=e[s],o=r[s];o&&i!==o&&!(F(i)&&i.includes(o))&&(e[s]=i?[].concat(i,o):o)}else s!==""&&(e[s]=r[s])}return e}function Le(t,e,n,r=null){Pe(t,e,7,[n,r])}const Ou=ba();let ku=0;function Nu(t,e,n){const r=t.type,s=(e?e.appContext:t.appContext)||Ou,i={uid:ku++,vnode:t,type:r,parent:e,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,scope:new Qc(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(s.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Ia(r,s),emitsOptions:ua(r,s),emit:null,emitted:null,propsDefaults:Q,inheritAttrs:r.inheritAttrs,ctx:Q,data:Q,props:Q,attrs:Q,slots:Q,refs:Q,setupState:Q,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=e?e.root:i,i.emit=Fl.bind(null,i),t.ce&&t.ce(i),i}let ae=null,qs,Lt,Di="__VUE_INSTANCE_SETTERS__";(Lt=rs()[Di])||(Lt=rs()[Di]=[]),Lt.push(t=>ae=t),qs=t=>{Lt.length>1?Lt.forEach(e=>e(t)):Lt[0](t)};const Xt=t=>{qs(t),t.scope.on()},Rt=()=>{ae&&ae.scope.off(),qs(null)};function Pa(t){return t.vnode.shapeFlag&4}let Cn=!1;function Du(t,e=!1){Cn=e;const{props:n,children:r}=t.vnode,s=Pa(t);gu(t,n,s,e),vu(t,r);const i=s?Mu(t,e):void 0;return Cn=!1,i}function Mu(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=Zo(new Proxy(t.ctx,au));const{setup:r}=n;if(r){const s=t.setupContext=r.length>1?Lu(t):null;Xt(t),nn();const i=ft(r,t,0,[t.props,s]);if(rn(),Rt(),Lo(i)){if(i.then(Rt,Rt),e)return i.then(o=>{Mi(t,o,e)}).catch(o=>{Cr(o,t,0)});t.asyncDep=i}else Mi(t,i,e)}else Oa(t,e)}function Mi(t,e,n){$(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:Z(e)&&(t.setupState=sa(e)),Oa(t,n)}let xi;function Oa(t,e,n){const r=t.type;if(!t.render){if(!e&&xi&&!r.render){const s=r.template||Vs(t).template;if(s){const{isCustomElement:i,compilerOptions:o}=t.appContext.config,{delimiters:a,compilerOptions:c}=r,l=oe(oe({isCustomElement:i,delimiters:a},o),c);r.render=xi(s,l)}}t.render=r.render||Ae}Xt(t),nn(),cu(t),rn(),Rt()}function xu(t){return t.attrsProxy||(t.attrsProxy=new Proxy(t.attrs,{get(e,n){return me(t,"get","$attrs"),e[n]}}))}function Lu(t){const e=n=>{t.exposed=n||{}};return{get attrs(){return xu(t)},slots:t.slots,emit:t.emit,expose:e}}function Nr(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(sa(Zo(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in mn)return mn[n](t)},has(e,n){return n in e||n in mn}}))}function Uu(t,e=!0){return $(t)?t.displayName||t.name:t.name||e&&t.__name}function Fu(t){return $(t)&&"__vccOpts"in t}const be=(t,e)=>Nl(t,e,Cn);function ka(t,e,n){const r=arguments.length;return r===2?Z(e)&&!F(e)?gs(e)?re(t,null,[e]):re(t,e):re(t,null,e):(r>3?n=Array.prototype.slice.call(arguments,2):r===3&&gs(n)&&(n=[n]),re(t,e,n))}const Bu=Symbol.for("v-scx"),$u=()=>Oe(Bu),Hu="3.3.4",ju="http://www.w3.org/2000/svg",Et=typeof document<"u"?document:null,Li=Et&&Et.createElement("template"),Wu={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,r)=>{const s=e?Et.createElementNS(ju,t):Et.createElement(t,n?{is:n}:void 0);return t==="select"&&r&&r.multiple!=null&&s.setAttribute("multiple",r.multiple),s},createText:t=>Et.createTextNode(t),createComment:t=>Et.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Et.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,n,r,s,i){const o=n?n.previousSibling:e.lastChild;if(s&&(s===i||s.nextSibling))for(;e.insertBefore(s.cloneNode(!0),n),!(s===i||!(s=s.nextSibling)););else{Li.innerHTML=r?`<svg>${t}</svg>`:t;const a=Li.content;if(r){const c=a.firstChild;for(;c.firstChild;)a.appendChild(c.firstChild);a.removeChild(c)}e.insertBefore(a,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}};function Vu(t,e,n){const r=t._vtc;r&&(e=(e?[e,...r]:[...r]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}function zu(t,e,n){const r=t.style,s=se(n);if(n&&!s){if(e&&!se(e))for(const i in e)n[i]==null&&ms(r,i,"");for(const i in n)ms(r,i,n[i])}else{const i=r.display;s?e!==n&&(r.cssText=n):e&&t.removeAttribute("style"),"_vod"in t&&(r.display=i)}}const Ui=/\s*!important$/;function ms(t,e,n){if(F(n))n.forEach(r=>ms(t,e,r));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const r=Ku(t,e);Ui.test(n)?t.setProperty(tn(r),n.replace(Ui,""),"important"):t[r]=n}}const Fi=["Webkit","Moz","ms"],jr={};function Ku(t,e){const n=jr[e];if(n)return n;let r=je(e);if(r!=="filter"&&r in t)return jr[e]=r;r=Tr(r);for(let s=0;s<Fi.length;s++){const i=Fi[s]+r;if(i in t)return jr[e]=i}return e}const Bi="http://www.w3.org/1999/xlink";function qu(t,e,n,r,s){if(r&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(Bi,e.slice(6,e.length)):t.setAttributeNS(Bi,e,n);else{const i=Xc(e);n==null||i&&!Bo(n)?t.removeAttribute(e):t.setAttribute(e,i?"":n)}}function Gu(t,e,n,r,s,i,o){if(e==="innerHTML"||e==="textContent"){r&&o(r,s,i),t[e]=n??"";return}const a=t.tagName;if(e==="value"&&a!=="PROGRESS"&&!a.includes("-")){t._value=n;const l=a==="OPTION"?t.getAttribute("value"):t.value,u=n??"";l!==u&&(t.value=u),n==null&&t.removeAttribute(e);return}let c=!1;if(n===""||n==null){const l=typeof t[e];l==="boolean"?n=Bo(n):n==null&&l==="string"?(n="",c=!0):l==="number"&&(n=0,c=!0)}try{t[e]=n}catch{}c&&t.removeAttribute(e)}function Bt(t,e,n,r){t.addEventListener(e,n,r)}function Ju(t,e,n,r){t.removeEventListener(e,n,r)}function Yu(t,e,n,r,s=null){const i=t._vei||(t._vei={}),o=i[e];if(r&&o)o.value=r;else{const[a,c]=Xu(e);if(r){const l=i[e]=ef(r,s);Bt(t,a,l,c)}else o&&(Ju(t,a,o,c),i[e]=void 0)}}const $i=/(?:Once|Passive|Capture)$/;function Xu(t){let e;if($i.test(t)){e={};let r;for(;r=t.match($i);)t=t.slice(0,t.length-r[0].length),e[r[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):tn(t.slice(2)),e]}let Wr=0;const Qu=Promise.resolve(),Zu=()=>Wr||(Qu.then(()=>Wr=0),Wr=Date.now());function ef(t,e){const n=r=>{if(!r._vts)r._vts=Date.now();else if(r._vts<=n.attached)return;Pe(tf(r,n.value),e,5,[r])};return n.value=t,n.attached=Zu(),n}function tf(t,e){if(F(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(r=>s=>!s._stopped&&r&&r(s))}else return e}const Hi=/^on[a-z]/,nf=(t,e,n,r,s=!1,i,o,a,c)=>{e==="class"?Vu(t,r,s):e==="style"?zu(t,n,r):Er(e)?Ps(e)||Yu(t,e,n,r,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):rf(t,e,r,s))?Gu(t,e,r,i,o,a,c):(e==="true-value"?t._trueValue=r:e==="false-value"&&(t._falseValue=r),qu(t,e,r,s))};function rf(t,e,n,r){return r?!!(e==="innerHTML"||e==="textContent"||e in t&&Hi.test(e)&&$(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||Hi.test(e)&&se(n)?!1:e in t}const ji=t=>{const e=t.props["onUpdate:modelValue"]||!1;return F(e)?n=>Xn(e,n):e};function sf(t){t.target.composing=!0}function Wi(t){const e=t.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const mm={created(t,{modifiers:{lazy:e,trim:n,number:r}},s){t._assign=ji(s);const i=r||s.props&&s.props.type==="number";Bt(t,e?"change":"input",o=>{if(o.target.composing)return;let a=t.value;n&&(a=a.trim()),i&&(a=ns(a)),t._assign(a)}),n&&Bt(t,"change",()=>{t.value=t.value.trim()}),e||(Bt(t,"compositionstart",sf),Bt(t,"compositionend",Wi),Bt(t,"change",Wi))},mounted(t,{value:e}){t.value=e??""},beforeUpdate(t,{value:e,modifiers:{lazy:n,trim:r,number:s}},i){if(t._assign=ji(i),t.composing||document.activeElement===t&&t.type!=="range"&&(n||r&&t.value.trim()===e||(s||t.type==="number")&&ns(t.value)===e))return;const o=e??"";t.value!==o&&(t.value=o)}},of=oe({patchProp:nf},Wu);let Vi;function af(){return Vi||(Vi=bu(of))}const cf=(...t)=>{const e=af().createApp(...t),{mount:n}=e;return e.mount=r=>{const s=lf(r);if(!s)return;const i=e._component;!$(i)&&!i.render&&!i.template&&(i.template=s.innerHTML),s.innerHTML="";const o=n(s,!1,s instanceof SVGElement);return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),o},e};function lf(t){return se(t)?document.querySelector(t):t}/*!
  * vue-router v4.2.0
  * (c) 2023 Eduardo San Martin Morote
  * @license MIT
  */const $t=typeof window<"u";function uf(t){return t.__esModule||t[Symbol.toStringTag]==="Module"}const q=Object.assign;function Vr(t,e){const n={};for(const r in e){const s=e[r];n[r]=ke(s)?s.map(t):t(s)}return n}const vn=()=>{},ke=Array.isArray,ff=/\/$/,df=t=>t.replace(ff,"");function zr(t,e,n="/"){let r,s={},i="",o="";const a=e.indexOf("#");let c=e.indexOf("?");return a<c&&a>=0&&(c=-1),c>-1&&(r=e.slice(0,c),i=e.slice(c+1,a>-1?a:e.length),s=t(i)),a>-1&&(r=r||e.slice(0,a),o=e.slice(a,e.length)),r=mf(r??e,n),{fullPath:r+(i&&"?")+i+o,path:r,query:s,hash:o}}function hf(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function zi(t,e){return!e||!t.toLowerCase().startsWith(e.toLowerCase())?t:t.slice(e.length)||"/"}function pf(t,e,n){const r=e.matched.length-1,s=n.matched.length-1;return r>-1&&r===s&&Qt(e.matched[r],n.matched[s])&&Na(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function Qt(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function Na(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!gf(t[n],e[n]))return!1;return!0}function gf(t,e){return ke(t)?Ki(t,e):ke(e)?Ki(e,t):t===e}function Ki(t,e){return ke(e)?t.length===e.length&&t.every((n,r)=>n===e[r]):t.length===1&&t[0]===e}function mf(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),r=t.split("/"),s=r[r.length-1];(s===".."||s===".")&&r.push("");let i=n.length-1,o,a;for(o=0;o<r.length;o++)if(a=r[o],a!==".")if(a==="..")i>1&&i--;else break;return n.slice(0,i).join("/")+"/"+r.slice(o-(o===r.length?1:0)).join("/")}var Sn;(function(t){t.pop="pop",t.push="push"})(Sn||(Sn={}));var yn;(function(t){t.back="back",t.forward="forward",t.unknown=""})(yn||(yn={}));function _f(t){if(!t)if($t){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),df(t)}const vf=/^[^#]+#/;function yf(t,e){return t.replace(vf,"#")+e}function bf(t,e){const n=document.documentElement.getBoundingClientRect(),r=t.getBoundingClientRect();return{behavior:e.behavior,left:r.left-n.left-(e.left||0),top:r.top-n.top-(e.top||0)}}const Dr=()=>({left:window.pageXOffset,top:window.pageYOffset});function Ef(t){let e;if("el"in t){const n=t.el,r=typeof n=="string"&&n.startsWith("#"),s=typeof n=="string"?r?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!s)return;e=bf(s,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.pageXOffset,e.top!=null?e.top:window.pageYOffset)}function qi(t,e){return(history.state?history.state.position-e:-1)+t}const _s=new Map;function If(t,e){_s.set(t,e)}function wf(t){const e=_s.get(t);return _s.delete(t),e}let Tf=()=>location.protocol+"//"+location.host;function Da(t,e){const{pathname:n,search:r,hash:s}=e,i=t.indexOf("#");if(i>-1){let a=s.includes(t.slice(i))?t.slice(i).length:1,c=s.slice(a);return c[0]!=="/"&&(c="/"+c),zi(c,"")}return zi(n,t)+r+s}function Rf(t,e,n,r){let s=[],i=[],o=null;const a=({state:g})=>{const y=Da(t,location),S=n.value,P=e.value;let L=0;if(g){if(n.value=y,e.value=g,o&&o===S){o=null;return}L=P?g.position-P.position:0}else r(y);s.forEach(k=>{k(n.value,S,{delta:L,type:Sn.pop,direction:L?L>0?yn.forward:yn.back:yn.unknown})})};function c(){o=n.value}function l(g){s.push(g);const y=()=>{const S=s.indexOf(g);S>-1&&s.splice(S,1)};return i.push(y),y}function u(){const{history:g}=window;g.state&&g.replaceState(q({},g.state,{scroll:Dr()}),"")}function h(){for(const g of i)g();i=[],window.removeEventListener("popstate",a),window.removeEventListener("beforeunload",u)}return window.addEventListener("popstate",a),window.addEventListener("beforeunload",u,{passive:!0}),{pauseListeners:c,listen:l,destroy:h}}function Gi(t,e,n,r=!1,s=!1){return{back:t,current:e,forward:n,replaced:r,position:window.history.length,scroll:s?Dr():null}}function Cf(t){const{history:e,location:n}=window,r={value:Da(t,n)},s={value:e.state};s.value||i(r.value,{back:null,current:r.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function i(c,l,u){const h=t.indexOf("#"),g=h>-1?(n.host&&document.querySelector("base")?t:t.slice(h))+c:Tf()+t+c;try{e[u?"replaceState":"pushState"](l,"",g),s.value=l}catch(y){console.error(y),n[u?"replace":"assign"](g)}}function o(c,l){const u=q({},e.state,Gi(s.value.back,c,s.value.forward,!0),l,{position:s.value.position});i(c,u,!0),r.value=c}function a(c,l){const u=q({},s.value,e.state,{forward:c,scroll:Dr()});i(u.current,u,!0);const h=q({},Gi(r.value,c,null),{position:u.position+1},l);i(c,h,!1),r.value=c}return{location:r,state:s,push:a,replace:o}}function Sf(t){t=_f(t);const e=Cf(t),n=Rf(t,e.state,e.location,e.replace);function r(i,o=!0){o||n.pauseListeners(),history.go(i)}const s=q({location:"",base:t,go:r,createHref:yf.bind(null,t)},e,n);return Object.defineProperty(s,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(s,"state",{enumerable:!0,get:()=>e.state.value}),s}function Af(t){return typeof t=="string"||t&&typeof t=="object"}function Ma(t){return typeof t=="string"||typeof t=="symbol"}const tt={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},xa=Symbol("");var Ji;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(Ji||(Ji={}));function Zt(t,e){return q(new Error,{type:t,[xa]:!0},e)}function Ve(t,e){return t instanceof Error&&xa in t&&(e==null||!!(t.type&e))}const Yi="[^/]+?",Pf={sensitive:!1,strict:!1,start:!0,end:!0},Of=/[.+*?^${}()[\]/\\]/g;function kf(t,e){const n=q({},Pf,e),r=[];let s=n.start?"^":"";const i=[];for(const l of t){const u=l.length?[]:[90];n.strict&&!l.length&&(s+="/");for(let h=0;h<l.length;h++){const g=l[h];let y=40+(n.sensitive?.25:0);if(g.type===0)h||(s+="/"),s+=g.value.replace(Of,"\\$&"),y+=40;else if(g.type===1){const{value:S,repeatable:P,optional:L,regexp:k}=g;i.push({name:S,repeatable:P,optional:L});const M=k||Yi;if(M!==Yi){y+=10;try{new RegExp(`(${M})`)}catch(x){throw new Error(`Invalid custom RegExp for param "${S}" (${M}): `+x.message)}}let j=P?`((?:${M})(?:/(?:${M}))*)`:`(${M})`;h||(j=L&&l.length<2?`(?:/${j})`:"/"+j),L&&(j+="?"),s+=j,y+=20,L&&(y+=-8),P&&(y+=-20),M===".*"&&(y+=-50)}u.push(y)}r.push(u)}if(n.strict&&n.end){const l=r.length-1;r[l][r[l].length-1]+=.7000000000000001}n.strict||(s+="/?"),n.end?s+="$":n.strict&&(s+="(?:/|$)");const o=new RegExp(s,n.sensitive?"":"i");function a(l){const u=l.match(o),h={};if(!u)return null;for(let g=1;g<u.length;g++){const y=u[g]||"",S=i[g-1];h[S.name]=y&&S.repeatable?y.split("/"):y}return h}function c(l){let u="",h=!1;for(const g of t){(!h||!u.endsWith("/"))&&(u+="/"),h=!1;for(const y of g)if(y.type===0)u+=y.value;else if(y.type===1){const{value:S,repeatable:P,optional:L}=y,k=S in l?l[S]:"";if(ke(k)&&!P)throw new Error(`Provided param "${S}" is an array but it is not repeatable (* or + modifiers)`);const M=ke(k)?k.join("/"):k;if(!M)if(L)g.length<2&&(u.endsWith("/")?u=u.slice(0,-1):h=!0);else throw new Error(`Missing required param "${S}"`);u+=M}}return u||"/"}return{re:o,score:r,keys:i,parse:a,stringify:c}}function Nf(t,e){let n=0;for(;n<t.length&&n<e.length;){const r=e[n]-t[n];if(r)return r;n++}return t.length<e.length?t.length===1&&t[0]===40+40?-1:1:t.length>e.length?e.length===1&&e[0]===40+40?1:-1:0}function Df(t,e){let n=0;const r=t.score,s=e.score;for(;n<r.length&&n<s.length;){const i=Nf(r[n],s[n]);if(i)return i;n++}if(Math.abs(s.length-r.length)===1){if(Xi(r))return 1;if(Xi(s))return-1}return s.length-r.length}function Xi(t){const e=t[t.length-1];return t.length>0&&e[e.length-1]<0}const Mf={type:0,value:""},xf=/[a-zA-Z0-9_]/;function Lf(t){if(!t)return[[]];if(t==="/")return[[Mf]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(y){throw new Error(`ERR (${n})/"${l}": ${y}`)}let n=0,r=n;const s=[];let i;function o(){i&&s.push(i),i=[]}let a=0,c,l="",u="";function h(){l&&(n===0?i.push({type:0,value:l}):n===1||n===2||n===3?(i.length>1&&(c==="*"||c==="+")&&e(`A repeatable param (${l}) must be alone in its segment. eg: '/:ids+.`),i.push({type:1,value:l,regexp:u,repeatable:c==="*"||c==="+",optional:c==="*"||c==="?"})):e("Invalid state to consume buffer"),l="")}function g(){l+=c}for(;a<t.length;){if(c=t[a++],c==="\\"&&n!==2){r=n,n=4;continue}switch(n){case 0:c==="/"?(l&&h(),o()):c===":"?(h(),n=1):g();break;case 4:g(),n=r;break;case 1:c==="("?n=2:xf.test(c)?g():(h(),n=0,c!=="*"&&c!=="?"&&c!=="+"&&a--);break;case 2:c===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+c:n=3:u+=c;break;case 3:h(),n=0,c!=="*"&&c!=="?"&&c!=="+"&&a--,u="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${l}"`),h(),o(),s}function Uf(t,e,n){const r=kf(Lf(t.path),n),s=q(r,{record:t,parent:e,children:[],alias:[]});return e&&!s.record.aliasOf==!e.record.aliasOf&&e.children.push(s),s}function Ff(t,e){const n=[],r=new Map;e=eo({strict:!1,end:!0,sensitive:!1},e);function s(u){return r.get(u)}function i(u,h,g){const y=!g,S=Bf(u);S.aliasOf=g&&g.record;const P=eo(e,u),L=[S];if("alias"in u){const j=typeof u.alias=="string"?[u.alias]:u.alias;for(const x of j)L.push(q({},S,{components:g?g.record.components:S.components,path:x,aliasOf:g?g.record:S}))}let k,M;for(const j of L){const{path:x}=j;if(h&&x[0]!=="/"){const te=h.record.path,ne=te[te.length-1]==="/"?"":"/";j.path=h.record.path+(x&&ne+x)}if(k=Uf(j,h,P),g?g.alias.push(k):(M=M||k,M!==k&&M.alias.push(k),y&&u.name&&!Zi(k)&&o(u.name)),S.children){const te=S.children;for(let ne=0;ne<te.length;ne++)i(te[ne],k,g&&g.children[ne])}g=g||k,(k.record.components&&Object.keys(k.record.components).length||k.record.name||k.record.redirect)&&c(k)}return M?()=>{o(M)}:vn}function o(u){if(Ma(u)){const h=r.get(u);h&&(r.delete(u),n.splice(n.indexOf(h),1),h.children.forEach(o),h.alias.forEach(o))}else{const h=n.indexOf(u);h>-1&&(n.splice(h,1),u.record.name&&r.delete(u.record.name),u.children.forEach(o),u.alias.forEach(o))}}function a(){return n}function c(u){let h=0;for(;h<n.length&&Df(u,n[h])>=0&&(u.record.path!==n[h].record.path||!La(u,n[h]));)h++;n.splice(h,0,u),u.record.name&&!Zi(u)&&r.set(u.record.name,u)}function l(u,h){let g,y={},S,P;if("name"in u&&u.name){if(g=r.get(u.name),!g)throw Zt(1,{location:u});P=g.record.name,y=q(Qi(h.params,g.keys.filter(M=>!M.optional).map(M=>M.name)),u.params&&Qi(u.params,g.keys.map(M=>M.name))),S=g.stringify(y)}else if("path"in u)S=u.path,g=n.find(M=>M.re.test(S)),g&&(y=g.parse(S),P=g.record.name);else{if(g=h.name?r.get(h.name):n.find(M=>M.re.test(h.path)),!g)throw Zt(1,{location:u,currentLocation:h});P=g.record.name,y=q({},h.params,u.params),S=g.stringify(y)}const L=[];let k=g;for(;k;)L.unshift(k.record),k=k.parent;return{name:P,path:S,params:y,matched:L,meta:Hf(L)}}return t.forEach(u=>i(u)),{addRoute:i,resolve:l,removeRoute:o,getRoutes:a,getRecordMatcher:s}}function Qi(t,e){const n={};for(const r of e)r in t&&(n[r]=t[r]);return n}function Bf(t){return{path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:void 0,beforeEnter:t.beforeEnter,props:$f(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}}}function $f(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const r in t.components)e[r]=typeof n=="boolean"?n:n[r];return e}function Zi(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function Hf(t){return t.reduce((e,n)=>q(e,n.meta),{})}function eo(t,e){const n={};for(const r in t)n[r]=r in e?e[r]:t[r];return n}function La(t,e){return e.children.some(n=>n===t||La(t,n))}const Ua=/#/g,jf=/&/g,Wf=/\//g,Vf=/=/g,zf=/\?/g,Fa=/\+/g,Kf=/%5B/g,qf=/%5D/g,Ba=/%5E/g,Gf=/%60/g,$a=/%7B/g,Jf=/%7C/g,Ha=/%7D/g,Yf=/%20/g;function Gs(t){return encodeURI(""+t).replace(Jf,"|").replace(Kf,"[").replace(qf,"]")}function Xf(t){return Gs(t).replace($a,"{").replace(Ha,"}").replace(Ba,"^")}function vs(t){return Gs(t).replace(Fa,"%2B").replace(Yf,"+").replace(Ua,"%23").replace(jf,"%26").replace(Gf,"`").replace($a,"{").replace(Ha,"}").replace(Ba,"^")}function Qf(t){return vs(t).replace(Vf,"%3D")}function Zf(t){return Gs(t).replace(Ua,"%23").replace(zf,"%3F")}function ed(t){return t==null?"":Zf(t).replace(Wf,"%2F")}function fr(t){try{return decodeURIComponent(""+t)}catch{}return""+t}function td(t){const e={};if(t===""||t==="?")return e;const r=(t[0]==="?"?t.slice(1):t).split("&");for(let s=0;s<r.length;++s){const i=r[s].replace(Fa," "),o=i.indexOf("="),a=fr(o<0?i:i.slice(0,o)),c=o<0?null:fr(i.slice(o+1));if(a in e){let l=e[a];ke(l)||(l=e[a]=[l]),l.push(c)}else e[a]=c}return e}function to(t){let e="";for(let n in t){const r=t[n];if(n=Qf(n),r==null){r!==void 0&&(e+=(e.length?"&":"")+n);continue}(ke(r)?r.map(i=>i&&vs(i)):[r&&vs(r)]).forEach(i=>{i!==void 0&&(e+=(e.length?"&":"")+n,i!=null&&(e+="="+i))})}return e}function nd(t){const e={};for(const n in t){const r=t[n];r!==void 0&&(e[n]=ke(r)?r.map(s=>s==null?null:""+s):r==null?r:""+r)}return e}const rd=Symbol(""),no=Symbol(""),Mr=Symbol(""),Js=Symbol(""),ys=Symbol("");function fn(){let t=[];function e(r){return t.push(r),()=>{const s=t.indexOf(r);s>-1&&t.splice(s,1)}}function n(){t=[]}return{add:e,list:()=>t,reset:n}}function it(t,e,n,r,s){const i=r&&(r.enterCallbacks[s]=r.enterCallbacks[s]||[]);return()=>new Promise((o,a)=>{const c=h=>{h===!1?a(Zt(4,{from:n,to:e})):h instanceof Error?a(h):Af(h)?a(Zt(2,{from:e,to:h})):(i&&r.enterCallbacks[s]===i&&typeof h=="function"&&i.push(h),o())},l=t.call(r&&r.instances[s],e,n,c);let u=Promise.resolve(l);t.length<3&&(u=u.then(c)),u.catch(h=>a(h))})}function Kr(t,e,n,r){const s=[];for(const i of t)for(const o in i.components){let a=i.components[o];if(!(e!=="beforeRouteEnter"&&!i.instances[o]))if(sd(a)){const l=(a.__vccOpts||a)[e];l&&s.push(it(l,n,r,i,o))}else{let c=a();s.push(()=>c.then(l=>{if(!l)return Promise.reject(new Error(`Couldn't resolve component "${o}" at "${i.path}"`));const u=uf(l)?l.default:l;i.components[o]=u;const g=(u.__vccOpts||u)[e];return g&&it(g,n,r,i,o)()}))}}return s}function sd(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function ro(t){const e=Oe(Mr),n=Oe(Js),r=be(()=>e.resolve(Vt(t.to))),s=be(()=>{const{matched:c}=r.value,{length:l}=c,u=c[l-1],h=n.matched;if(!u||!h.length)return-1;const g=h.findIndex(Qt.bind(null,u));if(g>-1)return g;const y=so(c[l-2]);return l>1&&so(u)===y&&h[h.length-1].path!==y?h.findIndex(Qt.bind(null,c[l-2])):g}),i=be(()=>s.value>-1&&cd(n.params,r.value.params)),o=be(()=>s.value>-1&&s.value===n.matched.length-1&&Na(n.params,r.value.params));function a(c={}){return ad(c)?e[Vt(t.replace)?"replace":"push"](Vt(t.to)).catch(vn):Promise.resolve()}return{route:r,href:be(()=>r.value.href),isActive:i,isExactActive:o,navigate:a}}const id=ha({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:ro,setup(t,{slots:e}){const n=Mn(ro(t)),{options:r}=Oe(Mr),s=be(()=>({[io(t.activeClass,r.linkActiveClass,"router-link-active")]:n.isActive,[io(t.exactActiveClass,r.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const i=e.default&&e.default(n);return t.custom?i:ka("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:s.value},i)}}}),od=id;function ad(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function cd(t,e){for(const n in e){const r=e[n],s=t[n];if(typeof r=="string"){if(r!==s)return!1}else if(!ke(s)||s.length!==r.length||r.some((i,o)=>i!==s[o]))return!1}return!0}function so(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const io=(t,e,n)=>t??e??n,ld=ha({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:e,slots:n}){const r=Oe(ys),s=be(()=>t.route||r.value),i=Oe(no,0),o=be(()=>{let l=Vt(i);const{matched:u}=s.value;let h;for(;(h=u[l])&&!h.components;)l++;return l}),a=be(()=>s.value.matched[o.value]);er(no,be(()=>o.value+1)),er(rd,a),er(ys,s);const c=na();return Qn(()=>[c.value,a.value,t.name],([l,u,h],[g,y,S])=>{u&&(u.instances[h]=l,y&&y!==u&&l&&l===g&&(u.leaveGuards.size||(u.leaveGuards=y.leaveGuards),u.updateGuards.size||(u.updateGuards=y.updateGuards))),l&&u&&(!y||!Qt(u,y)||!g)&&(u.enterCallbacks[h]||[]).forEach(P=>P(l))},{flush:"post"}),()=>{const l=s.value,u=t.name,h=a.value,g=h&&h.components[u];if(!g)return oo(n.default,{Component:g,route:l});const y=h.props[u],S=y?y===!0?l.params:typeof y=="function"?y(l):y:null,L=ka(g,q({},S,e,{onVnodeUnmounted:k=>{k.component.isUnmounted&&(h.instances[u]=null)},ref:c}));return oo(n.default,{Component:L,route:l})||L}}});function oo(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const ud=ld;function fd(t){const e=Ff(t.routes,t),n=t.parseQuery||td,r=t.stringifyQuery||to,s=t.history,i=fn(),o=fn(),a=fn(),c=Al(tt);let l=tt;$t&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=Vr.bind(null,_=>""+_),h=Vr.bind(null,ed),g=Vr.bind(null,fr);function y(_,C){let T,O;return Ma(_)?(T=e.getRecordMatcher(_),O=C):O=_,e.addRoute(O,T)}function S(_){const C=e.getRecordMatcher(_);C&&e.removeRoute(C)}function P(){return e.getRoutes().map(_=>_.record)}function L(_){return!!e.getRecordMatcher(_)}function k(_,C){if(C=q({},C||c.value),typeof _=="string"){const p=zr(n,_,C.path),m=e.resolve({path:p.path},C),v=s.createHref(p.fullPath);return q(p,m,{params:g(m.params),hash:fr(p.hash),redirectedFrom:void 0,href:v})}let T;if("path"in _)T=q({},_,{path:zr(n,_.path,C.path).path});else{const p=q({},_.params);for(const m in p)p[m]==null&&delete p[m];T=q({},_,{params:h(p)}),C.params=h(C.params)}const O=e.resolve(T,C),K=_.hash||"";O.params=u(g(O.params));const f=hf(r,q({},_,{hash:Xf(K),path:O.path})),d=s.createHref(f);return q({fullPath:f,hash:K,query:r===to?nd(_.query):_.query||{}},O,{redirectedFrom:void 0,href:d})}function M(_){return typeof _=="string"?zr(n,_,c.value.path):q({},_)}function j(_,C){if(l!==_)return Zt(8,{from:C,to:_})}function x(_){return _e(_)}function te(_){return x(q(M(_),{replace:!0}))}function ne(_){const C=_.matched[_.matched.length-1];if(C&&C.redirect){const{redirect:T}=C;let O=typeof T=="function"?T(_):T;return typeof O=="string"&&(O=O.includes("?")||O.includes("#")?O=M(O):{path:O},O.params={}),q({query:_.query,hash:_.hash,params:"path"in O?{}:_.params},O)}}function _e(_,C){const T=l=k(_),O=c.value,K=_.state,f=_.force,d=_.replace===!0,p=ne(T);if(p)return _e(q(M(p),{state:typeof p=="object"?q({},K,p.state):K,force:f,replace:d}),C||T);const m=T;m.redirectedFrom=C;let v;return!f&&pf(r,O,T)&&(v=Zt(16,{to:m,from:O}),Me(O,O,!0,!1)),(v?Promise.resolve(v):ye(m,O)).catch(b=>Ve(b)?Ve(b,2)?b:Ze(b):z(b,m,O)).then(b=>{if(b){if(Ve(b,2))return _e(q({replace:d},M(b.to),{state:typeof b.to=="object"?q({},K,b.to.state):K,force:f}),C||m)}else b=mt(m,O,!0,d,K);return Qe(m,O,b),b})}function we(_,C){const T=j(_,C);return T?Promise.reject(T):Promise.resolve()}function Ne(_){const C=Mt.values().next().value;return C&&typeof C.runWithContext=="function"?C.runWithContext(_):_()}function ye(_,C){let T;const[O,K,f]=dd(_,C);T=Kr(O.reverse(),"beforeRouteLeave",_,C);for(const p of O)p.leaveGuards.forEach(m=>{T.push(it(m,_,C))});const d=we.bind(null,_,C);return T.push(d),ce(T).then(()=>{T=[];for(const p of i.list())T.push(it(p,_,C));return T.push(d),ce(T)}).then(()=>{T=Kr(K,"beforeRouteUpdate",_,C);for(const p of K)p.updateGuards.forEach(m=>{T.push(it(m,_,C))});return T.push(d),ce(T)}).then(()=>{T=[];for(const p of _.matched)if(p.beforeEnter&&!C.matched.includes(p))if(ke(p.beforeEnter))for(const m of p.beforeEnter)T.push(it(m,_,C));else T.push(it(p.beforeEnter,_,C));return T.push(d),ce(T)}).then(()=>(_.matched.forEach(p=>p.enterCallbacks={}),T=Kr(f,"beforeRouteEnter",_,C),T.push(d),ce(T))).then(()=>{T=[];for(const p of o.list())T.push(it(p,_,C));return T.push(d),ce(T)}).catch(p=>Ve(p,8)?p:Promise.reject(p))}function Qe(_,C,T){for(const O of a.list())Ne(()=>O(_,C,T))}function mt(_,C,T,O,K){const f=j(_,C);if(f)return f;const d=C===tt,p=$t?history.state:{};T&&(O||d?s.replace(_.fullPath,q({scroll:d&&p&&p.scroll},K)):s.push(_.fullPath,K)),c.value=_,Me(_,C,T,d),Ze()}let De;function cn(){De||(De=s.listen((_,C,T)=>{if(!jn.listening)return;const O=k(_),K=ne(O);if(K){_e(q(K,{replace:!0}),O).catch(vn);return}l=O;const f=c.value;$t&&If(qi(f.fullPath,T.delta),Dr()),ye(O,f).catch(d=>Ve(d,12)?d:Ve(d,2)?(_e(d.to,O).then(p=>{Ve(p,20)&&!T.delta&&T.type===Sn.pop&&s.go(-1,!1)}).catch(vn),Promise.reject()):(T.delta&&s.go(-T.delta,!1),z(d,O,f))).then(d=>{d=d||mt(O,f,!1),d&&(T.delta&&!Ve(d,8)?s.go(-T.delta,!1):T.type===Sn.pop&&Ve(d,20)&&s.go(-1,!1)),Qe(O,f,d)}).catch(vn)}))}let Nt=fn(),ie=fn(),J;function z(_,C,T){Ze(_);const O=ie.list();return O.length?O.forEach(K=>K(_,C,T)):console.error(_),Promise.reject(_)}function We(){return J&&c.value!==tt?Promise.resolve():new Promise((_,C)=>{Nt.add([_,C])})}function Ze(_){return J||(J=!_,cn(),Nt.list().forEach(([C,T])=>_?T(_):C()),Nt.reset()),_}function Me(_,C,T,O){const{scrollBehavior:K}=t;if(!$t||!K)return Promise.resolve();const f=!T&&wf(qi(_.fullPath,0))||(O||!T)&&history.state&&history.state.scroll||null;return oa().then(()=>K(_,C,f)).then(d=>d&&Ef(d)).catch(d=>z(d,_,C))}const he=_=>s.go(_);let Dt;const Mt=new Set,jn={currentRoute:c,listening:!0,addRoute:y,removeRoute:S,hasRoute:L,getRoutes:P,resolve:k,options:t,push:x,replace:te,go:he,back:()=>he(-1),forward:()=>he(1),beforeEach:i.add,beforeResolve:o.add,afterEach:a.add,onError:ie.add,isReady:We,install(_){const C=this;_.component("RouterLink",od),_.component("RouterView",ud),_.config.globalProperties.$router=C,Object.defineProperty(_.config.globalProperties,"$route",{enumerable:!0,get:()=>Vt(c)}),$t&&!Dt&&c.value===tt&&(Dt=!0,x(s.location).catch(K=>{}));const T={};for(const K in tt)T[K]=be(()=>c.value[K]);_.provide(Mr,C),_.provide(Js,Mn(T)),_.provide(ys,c);const O=_.unmount;Mt.add(_),_.unmount=function(){Mt.delete(_),Mt.size<1&&(l=tt,De&&De(),De=null,c.value=tt,Dt=!1,J=!1),O()}}};function ce(_){return _.reduce((C,T)=>C.then(()=>Ne(T)),Promise.resolve())}return jn}function dd(t,e){const n=[],r=[],s=[],i=Math.max(e.matched.length,t.matched.length);for(let o=0;o<i;o++){const a=e.matched[o];a&&(t.matched.find(l=>Qt(l,a))?r.push(a):n.push(a));const c=t.matched[o];c&&(e.matched.find(l=>Qt(l,c))||s.push(c))}return[n,r,s]}function hd(){return Oe(Mr)}function _m(){return Oe(Js)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fe(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Id(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(fe())}function wd(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function Td(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Rd(){const t=fe();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function Cd(){try{return typeof indexedDB=="object"}catch{return!1}}function Sd(){return new Promise((t,e)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(r);s.onsuccess=()=>{s.result.close(),n||self.indexedDB.deleteDatabase(r),t(!0)},s.onupgradeneeded=()=>{n=!1},s.onerror=()=>{var i;e(((i=s.error)===null||i===void 0?void 0:i.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ws="[DEFAULT]",Sh={[Is]:"fire-core",[nh]:"fire-core-compat",[sh]:"fire-analytics",[rh]:"fire-analytics-compat",[oh]:"fire-app-check",[ih]:"fire-app-check-compat",[ah]:"fire-auth",[ch]:"fire-auth-compat",[lh]:"fire-rtdb",[uh]:"fire-rtdb-compat",[fh]:"fire-fn",[dh]:"fire-fn-compat",[hh]:"fire-iid",[ph]:"fire-iid-compat",[gh]:"fire-fcm",[mh]:"fire-fcm-compat",[_h]:"fire-perf",[vh]:"fire-perf-compat",[yh]:"fire-rc",[bh]:"fire-rc-compat",[Eh]:"fire-gcs",[Ih]:"fire-gcs-compat",[wh]:"fire-fst",[Th]:"fire-fst-compat","fire-js":"fire-js",[Rh]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pr=new Map,Ts=new Map;function Ah(t,e){try{t.container.addComponent(e)}catch(n){At.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function An(t){const e=t.name;if(Ts.has(e))return At.debug(`There were multiple attempts to register component ${e}.`),!1;Ts.set(e,t);for(const n of pr.values())Ah(n,t);return!0}function Xa(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Un=Ch;function Qa(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:ws,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw ht.create("bad-app-name",{appName:String(s)});if(n||(n=Ka()),!n)throw ht.create("no-options");const i=pr.get(s);if(i){if(hr(n,i.options)&&hr(r,i.config))return i;throw ht.create("duplicate-app",{appName:s})}const o=new Fd(s);for(const c of Ts.values())o.addComponent(c);const a=new Oh(n,r,o);return pr.set(s,a),a}function kh(t=ws){const e=pr.get(t);if(!e&&t===ws&&Ka())return Qa();if(!e)throw ht.create("no-app",{appName:t});return e}function Kt(t,e,n){var r;let s=(r=Sh[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${s}" with version "${e}":`];i&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),At.warn(a.join(" "));return}An(new en(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nh="firebase-heartbeat-database",Dh=1,Pn="firebase-heartbeat-store";let Xr=null;function Za(){return Xr||(Xr=Xd(Nh,Dh,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(Pn)}}}).catch(t=>{throw ht.create("idb-open",{originalErrorMessage:t.message})})),Xr}async function Mh(t){try{return await(await Za()).transaction(Pn).objectStore(Pn).get(ec(t))}catch(e){if(e instanceof gt)At.warn(e.message);else{const n=ht.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});At.warn(n.message)}}}async function ho(t,e){try{const r=(await Za()).transaction(Pn,"readwrite");await r.objectStore(Pn).put(e,ec(t)),await r.done}catch(n){if(n instanceof gt)At.warn(n.message);else{const r=ht.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});At.warn(r.message)}}}function ec(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fn{constructor(e,n){this.shortDelay=e,this.longDelay=n,Je(n>e,"Short delay should be less than long delay!"),this.isMobile=Id()||Td()}get(){return zh()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mp(t,e){const n=Xa(t,"auth");if(n.isInitialized()){const s=n.getImmediate(),i=n.getOptions();if(hr(i,e??{}))return s;Ie(s,"already-initialized")}return n.initialize({options:e})}function _p(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(qe);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function vp(t,e,n){const r=kt(t);U(r._canInitEmulator,r,"emulator-config-failed"),U(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!!(n!=null&&n.disableWarnings),i=Ec(e),{host:o,port:a}=yp(e),c=a===null?"":`:${a}`;r.config.emulator={url:`${i}//${o}${c}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:o,port:a,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})}),s||bp()}function Ec(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function yp(t){const e=Ec(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:Io(r.substr(i.length+1))}}else{const[i,o]=r.split(":");return{host:i,port:Io(o)}}}function Io(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function bp(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rp(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Cp(t){const e=pn(gn(t)).link,n=e?pn(gn(e)).deep_link_id:null,r=pn(gn(t)).deep_link_id;return(r?pn(gn(r)).link:null)||r||n||e||t}class si{constructor(e){var n,r,s,i,o,a;const c=pn(gn(e)),l=(n=c.apiKey)!==null&&n!==void 0?n:null,u=(r=c.oobCode)!==null&&r!==void 0?r:null,h=Rp((s=c.mode)!==null&&s!==void 0?s:null);U(l&&u&&h,"argument-error"),this.apiKey=l,this.operation=h,this.code=u,this.continueUrl=(i=c.continueUrl)!==null&&i!==void 0?i:null,this.languageCode=(o=c.languageCode)!==null&&o!==void 0?o:null,this.tenantId=(a=c.tenantId)!==null&&a!==void 0?a:null}static parseLink(e){const n=Cp(e);try{return new si(n)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ot extends $n{constructor(){super("facebook.com")}static credential(e){return Pt._fromParams({providerId:ot.PROVIDER_ID,signInMethod:ot.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return ot.credentialFromTaggedObject(e)}static credentialFromError(e){return ot.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return ot.credential(e.oauthAccessToken)}catch{return null}}}ot.FACEBOOK_SIGN_IN_METHOD="facebook.com";ot.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ct extends $n{constructor(){super("github.com")}static credential(e){return Pt._fromParams({providerId:ct.PROVIDER_ID,signInMethod:ct.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return ct.credentialFromTaggedObject(e)}static credentialFromError(e){return ct.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return ct.credential(e.oauthAccessToken)}catch{return null}}}ct.GITHUB_SIGN_IN_METHOD="github.com";ct.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ap(t,e,n=!1){const{auth:r}=t,s="reauthenticate";try{const i=await On(t,Ic(r,s,e,t),n);U(i.idToken,r,"internal-error");const o=ti(i.idToken);U(o,r,"internal-error");const{sub:a}=o;return U(t.uid===a,r,"user-mismatch"),Ot._forOperation(t,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Ie(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wc(t,e,n=!1){const r="signIn",s=await Ic(t,r,e),i=await Ot._fromIdTokenResponse(t,r,s);return n||await t._updateCurrentUser(i.user),i}async function Pp(t,e){return wc(kt(t),e)}async function bm(t,e,n){var r;const s=kt(t),i={returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"};let o;if(!((r=s._getRecaptchaConfig())===null||r===void 0)&&r.emailPasswordEnabled){const l=await _r(s,i,"signUpPassword");o=es(s,l)}else o=es(s,i).catch(async l=>{if(l.code==="auth/missing-recaptcha-token"){console.log("Sign-up is protected by reCAPTCHA for this project. Automatically triggering the reCAPTCHA flow and restarting the sign-up flow.");const u=await _r(s,i,"signUpPassword");return es(s,u)}else return Promise.reject(l)});const a=await o.catch(l=>Promise.reject(l)),c=await Ot._fromIdTokenResponse(s,"signIn",a);return await s._updateCurrentUser(c.user),c}function Em(t,e,n){return Pp(Xe(t),an.credential(e,n))}function Op(t,e,n,r){return Xe(t).onIdTokenChanged(e,n,r)}function kp(t,e,n){return Xe(t).beforeAuthStateChanged(e,n)}function Tc(t,e,n,r){return Xe(t).onAuthStateChanged(e,n,r)}function Np(t){return Xe(t).signOut()}const yr="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sc extends Rc{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,n){}_removeListener(e,n){}}Sc.type="SESSION";const Ac=Sc;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mc{constructor(e,n,r,s,i=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=i,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:s,tenantId:i,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:n,sessionId:r,tenantId:i||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(l){this.reject(l)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Jp;case"linkViaPopup":case"linkViaRedirect":return Xp;case"reauthViaPopup":case"reauthViaRedirect":return Yp;default:Ie(this.auth,"internal-error")}}resolve(e){Je(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Je(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pg=new Fn(3e4,6e4);function So(){const t=He().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function gg(t){return new Promise((e,n)=>{var r,s,i;function o(){So(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{So(),n($e(t,"network-request-failed"))},timeout:pg.get()})}if(!((s=(r=He().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((i=He().gapi)===null||i===void 0)&&i.load)o();else{const a=up("iframefcb");return He()[a]=()=>{gapi.load?o():n($e(t,"network-request-failed"))},yc(`https://apis.google.com/js/api.js?onload=${a}`).catch(c=>n(c))}}).catch(e=>{throw ir=null,e})}let ir=null;function mg(t){return ir=ir||gg(t),ir}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tg={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Rg=500,Cg=600,Sg="_blank",Ag="http://localhost";class Ao{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function Pg(t,e,n,r=Rg,s=Cg){const i=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-r)/2,0).toString();let a="";const c=Object.assign(Object.assign({},Tg),{width:r.toString(),height:s.toString(),top:i,left:o}),l=fe().toLowerCase();n&&(a=uc(l)?Sg:n),lc(l)&&(e=e||Ag,c.scrollbars="yes");const u=Object.entries(c).reduce((g,[y,S])=>`${g}${y}=${S},`,"");if(op(l)&&a!=="_self")return Og(e||"",a),new Ao(null);const h=window.open(e||"",a,u);U(h,t,"popup-blocked");try{h.focus()}catch{}return new Ao(h)}function Og(t,e){const n=document.createElement("a");n.href=t,n.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ts="webStorageSupport";class xg{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Ac,this._completeRedirectFn=ig,this._overrideRedirectResult=ng}async _openPopup(e,n,r,s){var i;Je((i=this.eventManagers[e._key()])===null||i===void 0?void 0:i.manager,"_initialize() not called before _openPopup()");const o=await Po(e,n,r,Rs(),s);return Pg(e,o,oi())}async _openRedirect(e,n,r,s){await this._originValidation(e);const i=await Po(e,n,r,Rs(),s);return Bp(i),new Promise(()=>{})}_initialize(e){const n=e._key();if(this.eventManagers[n]){const{manager:s,promise:i}=this.eventManagers[n];return s?Promise.resolve(s):(Je(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[n]={promise:r},r.catch(()=>{delete this.eventManagers[n]}),r}async initAndGetManager(e){const n=await wg(e),r=new ag(e);return n.register("authEvent",s=>(U(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=n,r}_isIframeWebStorageSupported(e,n){this.iframes[e._key()].send(ts,{type:ts},s=>{var i;const o=(i=s==null?void 0:s[0])===null||i===void 0?void 0:i[ts];o!==void 0&&n(!!o),Ie(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const n=e._key();return this.originValidationPromises[n]||(this.originValidationPromises[n]=dg(e)),this.originValidationPromises[n]}get _shouldInitProactively(){return gc()||ni()||xr()}}const Lg=xg;var Oo="@firebase/auth",ko="0.23.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fg(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function Bg(t){An(new en("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=r.options;U(o&&!o.includes(":"),"invalid-api-key",{appName:r.name});const c={apiKey:o,authDomain:a,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:mc(t)},l=new gp(r,s,i,c);return _p(l,n),l},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),An(new en("auth-internal",e=>{const n=kt(e.getProvider("auth").getImmediate());return(r=>new Ug(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),Kt(Oo,ko,Fg(t)),Kt(Oo,ko,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $g=5*60,Hg=qa("authIdTokenMaxAge")||$g;let No=null;const jg=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Hg)return;const s=n==null?void 0:n.token;No!==s&&(No=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function Lc(t=kh()){const e=Xa(t,"auth");if(e.isInitialized())return e.getImmediate();const n=mp(t,{popupRedirectResolver:Lg,persistence:[Gp,Lp,Ac]}),r=qa("authTokenSyncURL");if(r){const i=jg(r);kp(n,i,()=>i(n.currentUser)),Op(n,o=>i(o))}const s=za("auth");return s&&vp(n,`http://${s}`),n}Bg("Browser");const Wg=(t,e)=>{const n=t.__vccOpts||t;for(const[r,s]of e)n[r]=s;return n},Vg=t=>(Bl("data-v-31353af1"),t=t(),$l(),t),zg={class:"navbar navbar-expand-lg navbar-dark",style:{"background-color":"#a1a0ac"}},Kg={class:"container-fluid"},qg=Vg(()=>ge("button",{class:"navbar-toggler",type:"button","data-bs-toggle":"collapse","data-bs-target":"#navbarNav","aria-controls":"navbarNav","aria-expanded":"false","aria-label":"Toggle navigation"},[ge("span",{class:"navbar-toggler-icon"})],-1)),Gg={class:"collapse navbar-collapse",id:"navbarNav"},Jg={class:"navbar-nav me-auto mb-2 mb-lg-0"},Yg={class:"nav-item"},Xg={class:"nav-item"},Qg={class:"nav-item"},Zg={class:"nav-item"},em={class:"nav-item"},tm={key:0,class:"nav-item"},nm={__name:"App",setup(t){const e=hd(),n=na(!1);let r;ma(()=>{r=Lc(),Tc(r,i=>{i?n.value=!0:n.value=!1})});const s=()=>{Np(r).then(()=>{e.push("/")})};return(i,o)=>{const a=Ei("router-link"),c=Ei("router-view");return ps(),Ni(Ue,null,[ge("nav",zg,[ge("div",Kg,[qg,ge("div",Gg,[ge("ul",Jg,[ge("li",Yg,[re(a,{class:"nav-link",to:"/Register"},{default:Ut(()=>[Ft(" Register")]),_:1})]),ge("li",Xg,[re(a,{class:"nav-link",to:"/SignIn"},{default:Ut(()=>[Ft(" Sign In")]),_:1})]),ge("li",Qg,[re(a,{class:"nav-link",to:"/DoctorList"},{default:Ut(()=>[Ft(" DoctorList")]),_:1})]),ge("li",Zg,[re(a,{class:"nav-link",to:"/Map"},{default:Ut(()=>[Ft(" Map")]),_:1})]),ge("li",em,[re(a,{class:"nav-link",to:"/Camera"},{default:Ut(()=>[Ft(" Camera")]),_:1})]),n.value?(ps(),Ni("li",tm,[ge("button",{class:"btn btn-primary sign-out-btn",onClick:s},"Sign out")])):Au("",!0)])])])]),re(c)],64)}}},rm=Wg(nm,[["__scopeId","data-v-31353af1"]]),sm="modulepreload",im=function(t){return"/"+t},Do={},rt=function(e,n,r){if(!n||n.length===0)return e();const s=document.getElementsByTagName("link");return Promise.all(n.map(i=>{if(i=im(i),i in Do)return;Do[i]=!0;const o=i.endsWith(".css"),a=o?'[rel="stylesheet"]':"";if(!!r)for(let u=s.length-1;u>=0;u--){const h=s[u];if(h.href===i&&(!o||h.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${a}`))return;const l=document.createElement("link");if(l.rel=o?"stylesheet":sm,o||(l.as="script",l.crossOrigin=""),l.href=i,document.head.appendChild(l),o)return new Promise((u,h)=>{l.addEventListener("load",u),l.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>e())},Uc=fd({history:Sf(),routes:[{path:"/",component:()=>rt(()=>import("./Register-c9fa1911.js"),["assets/Register-c9fa1911.js","assets/Register-380a9912.css"])},{path:"/register",component:()=>rt(()=>import("./Register-c9fa1911.js"),["assets/Register-c9fa1911.js","assets/Register-380a9912.css"])},{path:"/UserList",component:()=>rt(()=>import("./UserList-e94da553.js"),["assets/UserList-e94da553.js","assets/firebaseInit-397b36b9.js"]),meta:{requiresAuth:!0}},{path:"/DoctorList",component:()=>rt(()=>import("./DoctorList-e05a82f0.js"),["assets/DoctorList-e05a82f0.js","assets/firebaseInit-397b36b9.js","assets/DoctorList-24739d7b.css"]),meta:{requiresAuth:!0}},{path:"/Map",component:()=>rt(()=>import("./Map-f27ba7d0.js"),["assets/Map-f27ba7d0.js","assets/Map-ba8ab292.css"]),meta:{requiresAuth:!0}},{path:"/Camera",component:()=>rt(()=>import("./Camera-8d521c76.js"),["assets/Camera-8d521c76.js","assets/Camera-251769e0.css"])},{path:"/DoctorDetail/:id",component:()=>rt(()=>import("./DoctorDetail-e0714443.js"),["assets/DoctorDetail-e0714443.js","assets/firebaseInit-397b36b9.js","assets/DoctorDetail-71e67810.css"]),name:"DoctorDetail"},{path:"/SignIn",component:()=>rt(()=>import("./SignIn-bd1a7836.js"),[])}]}),om=()=>new Promise((t,e)=>{const n=Tc(Lc(),r=>{n(),t(r)},e)});Uc.beforeEach(async(t,e,n)=>{t.matched.some(r=>r.meta.requiresAuth)?await om()?n():(alert("Sign in to get access"),n("/register")):n()});var am="firebase",cm="9.22.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Kt(am,cm,"app");var lm=function(){return!!(window.location.hostname==="localhost"||window.location.hostname==="[::1]"||window.location.hostname.match(/^127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}$/))},Ss;typeof window<"u"&&(typeof Promise<"u"?Ss=new Promise(function(t){return window.addEventListener("load",t)}):Ss={then:function(t){return window.addEventListener("load",t)}});function um(t,e){e===void 0&&(e={});var n=e.registrationOptions;n===void 0&&(n={}),delete e.registrationOptions;var r=function(s){for(var i=[],o=arguments.length-1;o-- >0;)i[o]=arguments[o+1];e&&e[s]&&e[s].apply(e,i)};"serviceWorker"in navigator&&Ss.then(function(){lm()?(fm(t,r,n),navigator.serviceWorker.ready.then(function(s){r("ready",s)}).catch(function(s){return Dn(r,s)})):(Fc(t,r,n),navigator.serviceWorker.ready.then(function(s){r("ready",s)}).catch(function(s){return Dn(r,s)}))})}function Dn(t,e){navigator.onLine||t("offline"),t("error",e)}function Fc(t,e,n){navigator.serviceWorker.register(t,n).then(function(r){if(e("registered",r),r.waiting){e("updated",r);return}r.onupdatefound=function(){e("updatefound",r);var s=r.installing;s.onstatechange=function(){s.state==="installed"&&(navigator.serviceWorker.controller?e("updated",r):e("cached",r))}}}).catch(function(r){return Dn(e,r)})}function fm(t,e,n){fetch(t).then(function(r){r.status===404?(e("error",new Error("Service worker not found at "+t)),Mo()):r.headers.get("content-type").indexOf("javascript")===-1?(e("error",new Error("Expected "+t+" to have javascript content-type, but received "+r.headers.get("content-type"))),Mo()):Fc(t,e,n)}).catch(function(r){return Dn(e,r)})}function Mo(){"serviceWorker"in navigator&&navigator.serviceWorker.ready.then(function(t){t.unregister()}).catch(function(t){return Dn(emit,t)})}um(`${{}.BASE_URL}service-worker.js`,{ready(){console.log(`App is being served from cache by a service worker.
For more details, visit https://goo.gl/AFskqB`)},registered(){console.log("Service worker has been registered.")},cached(){console.log("Content has been cached for offline use.")},updatefound(){console.log("New content is downloading.")},updated(){console.log("New content is available; please refresh.")},offline(){console.log("No internet connection found. App is running in offline mode.")},error(t){console.error("Error during service worker registration:",t)}});const dm={apiKey:"AIzaSyDgznTMkxgRTJq34IlkPbv1b7go4Is_tQk",authDomain:"e-doctor-923d0.firebaseapp.com",projectId:"e-doctor-923d0",storageBucket:"e-doctor-923d0.appspot.com",messagingSenderId:"321148660890",appId:"1:321148660890:web:e20db85c65a91fd1c70323",measurementId:"G-BT5VX0BDF8"};Qa(dm);const Bc=cf(rm);Bc.use(Uc);Bc.mount("#app");export{kh as A,Xa as B,en as C,vm as D,ym as E,Ue as F,at as G,Ga as H,Qa as I,Em as J,Y as L,Un as S,Wg as _,ge as a,bm as b,Ni as c,$l as d,gm as e,Ei as f,Lc as g,re as h,Ut as i,Au as j,ma as k,_m as l,Ds as m,Ms as n,ps as o,Bl as p,An as q,na as r,Im as s,hm as t,hd as u,mm as v,pm as w,Kt as x,gt as y,Xe as z};
