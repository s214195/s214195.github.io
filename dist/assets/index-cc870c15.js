 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pr=new Map,Ts=new Map;function Ah(t,e){try{t.container.addComponent(e)}catch(n){Ot.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function An(t){const e=t.name;if(Ts.has(e))return Ot.debug(`There were multiple attempts to register component ${e}.`),!1;Ts.set(e,t);for(const n of pr.values())Ah(n,t);return!0}function Xa(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mp(t,e){const n=Xa(t,"auth");if(n.isInitialized()){const s=n.getImmediate(),i=n.getOptions();if(hr(i,e??{}))return s;Ie(s,"already-initialized")}return n.initialize({options:e})}function _p(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(qe);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function vp(t,e,n){const r=Dt(t);U(r._canInitEmulator,r,"emulator-config-failed"),U(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!!(n!=null&&n.disableWarnings),i=Ec(e),{host:o,port:a}=yp(e),c=a===null?"":`:${a}`;r.config.emulator={url:`${i}//${o}${c}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:o,port:a,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})}),s||bp()}function Ec(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function yp(t){const e=Ec(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:Io(r.substr(i.length+1))}}else{const[i,o]=r.split(":");return{host:i,port:Io(o)}}}function Io(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function bp(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ap(t,e,n=!1){const{auth:r}=t,s="reauthenticate";try{const i=await On(t,Ic(r,s,e,t),n);U(i.idToken,r,"internal-error");const o=ti(i.idToken);U(o,r,"internal-error");const{sub:a}=o;return U(t.uid===a,r,"user-mismatch"),Nt._forOperation(t,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Ie(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $g=5*60,Hg=qa("authIdTokenMaxAge")||$g;let No=null;const jg=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Hg)return;const s=n==null?void 0:n.token;No!==s&&(No=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function Lc(t=kh()){const e=Xa(t,"auth");if(e.isInitialized())return e.getImmediate();const n=mp(t,{popupRedirectResolver:Lg,persistence:[Gp,Lp,Ac]}),r=qa("authTokenSyncURL");if(r){const i=jg(r);kp(n,i,()=>i(n.currentUser)),Op(n,o=>i(o))}const s=za("auth");return s&&vp(n,`http://${s}`),n}Bg("Browser");const Wg=(t,e)=>{const n=t.__vccOpts||t;for(const[r,s]of e)n[r]=s;return n},Vg=t=>(Bl("data-v-486b1365"),t=t(),$l(),t),zg={class:"navbar navbar-expand-lg navbar-dark",style:{"background-color":"#a1a0ac"}},Kg={class:"container-fluid"},qg=Vg(()=>he("button",{class:"navbar-toggler",type:"button","data-bs-toggle":"collapse","data-bs-target":"#navbarNav","aria-controls":"navbarNav","aria-expanded":"false","aria-label":"Toggle navigation"},[he("span",{class:"navbar-toggler-icon"})],-1)),Gg={class:"collapse navbar-collapse",id:"navbarNav"},Jg={class:"navbar-nav me-auto mb-2 mb-lg-0"},Yg={class:"nav-item"},Xg={class:"nav-item"},Qg={class:"nav-item"},Zg={class:"nav-item"},em={class:"nav-item"},tm={class:"nav-item"},nm={key:0,class:"nav-item"},rm={__name:"App",setup(t){const e=hd(),n=na(!1);let r;ma(()=>{r=Lc(),Tc(r,i=>{i?n.value=!0:n.value=!1})});const s=()=>{Np(r).then(()=>{e.push("/")})};return(i,o)=>{const a=Ei("router-link"),c=Ei("router-view");return ps(),Ni(Ue,null,[he("nav",zg,[he("div",Kg,[qg,he("div",Gg,[he("ul",Jg,[he("li",Yg,[te(a,{class:"nav-link",to:"/Register"},{default:yt(()=>[bt(" Register")]),_:1})]),he("li",Xg,[te(a,{class:"nav-link",to:"/SignIn"},{default:yt(()=>[bt(" Sign In")]),_:1})]),he("li",Qg,[te(a,{class:"nav-link",to:"/UserList"},{default:yt(()=>[bt(" UserList")]),_:1})]),he("li",Zg,[te(a,{class:"nav-link",to:"/DoctorList"},{default:yt(()=>[bt(" DoctorList")]),_:1})]),he("li",em,[te(a,{class:"nav-link",to:"/Map"},{default:yt(()=>[bt(" Map")]),_:1})]),he("li",tm,[te(a,{class:"nav-link",to:"/Camera"},{default:yt(()=>[bt(" Camera")]),_:1})]),n.value?(ps(),Ni("li",nm,[he("button",{class:"btn btn-primary sign-out-btn",onClick:s},"Sign out")])):Au("",!0)])])])]),te(c)],64)}}},sm=Wg(rm,[["__scopeId","data-v-486b1365"]]),im="modulepreload",om=function(t){return"/"+t},Do={},rt=function(e,n,r){if(!n||n.length===0)return e();const s=document.getElementsByTagName("link");return Promise.all(n.map(i=>{if(i=om(i),i in Do)return;Do[i]=!0;const o=i.endsWith(".css"),a=o?'[rel="stylesheet"]':"";if(!!r)for(let u=s.length-1;u>=0;u--){const h=s[u];if(h.href===i&&(!o||h.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${a}`))return;const l=document.createElement("link");if(l.rel=o?"stylesheet":im,o||(l.as="script",l.crossOrigin=""),l.href=i,document.head.appendChild(l),o)return new Promise((u,h)=>{l.addEventListener("load",u),l.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>e())},Uc=fd({history:Sf(),routes:[{path:"/",component:()=>rt(()=>import("./Register-56e0ee04.js"),["assets/Register-56e0ee04.js","assets/Register-380a9912.css"])},{path:"/register",component:()=>rt(()=>import("./Register-56e0ee04.js"),["assets/Register-56e0ee04.js","assets/Register-380a9912.css"])},{path:"/UserList",component:()=>rt(()=>import("./UserList-1e0f2fa2.js"),["assets/UserList-1e0f2fa2.js","assets/firebaseInit-07883893.js"]),meta:{requiresAuth:!0}},{path:"/DoctorList",component:()=>rt(()=>import("./DoctorList-6b3e64e0.js"),["assets/DoctorList-6b3e64e0.js","assets/firebaseInit-07883893.js","assets/DoctorList-24739d7b.css"]),meta:{requiresAuth:!0}},{path:"/Map",component:()=>rt(()=>import("./Map-15e78ff4.js"),["assets/Map-15e78ff4.js","assets/Map-ba8ab292.css"]),meta:{requiresAuth:!0}},{path:"/Camera",component:()=>rt(()=>import("./Camera-a85387a1.js"),["assets/Camera-a85387a1.js","assets/Camera-251769e0.css"])},{path:"/DoctorDetail/:id",component:()=>rt(()=>import("./DoctorDetail-71e856ee.js"),["assets/DoctorDetail-71e856ee.js","assets/firebaseInit-07883893.js","assets/DoctorDetail-ad1db12a.css"]),name:"DoctorDetail"},{path:"/SignIn",component:()=>rt(()=>import("./SignIn-4c8f8089.js"),[])}]}),am=()=>new Promise((t,e)=>{const n=Tc(Lc(),r=>{n(),t(r)},e)});Uc.beforeEach(async(t,e,n)=>{t.matched.some(r=>r.meta.requiresAuth)?await am()?n():(alert("Sign in to get access"),n("/register")):n()});var cm="firebase",lm="9.22.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
